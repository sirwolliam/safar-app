  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── 1. Board hero — full bleed, departure counter top-right ── */}
        <TouchableOpacity style={jn.boardHero}
          ...
          <ImageBackground
            ...
            {/* Departure counter — top right corner */}
            <View style={jn.boardDeparture}>
              <Text style={jn.boardDepartureDays}>{daysUntil}</Text>
              <Text style={jn.boardDepartureLbl}>{"days to go"}</Text>
            </View>
        ...
        {/* ── 7. My Contacts (left) + My Groups (right) ── */}
...
const jn = StyleSheet.create({
  ...
  wideCardBg:      { flex:1 },
  wideCardScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.40)" },
  wideCardScrimDark:{ ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.50)" },
  ...
  pairCardBg:      { flex:1 },
  pairCardScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.55)" },
  pairCardScrimLight:{ ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.38)" },
