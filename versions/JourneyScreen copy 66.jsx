  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── 3. Du'ā Cards — Umrah (taller) + Hajj (shorter) ── */}
        <View style={jn.duaCardsRow}>

          {/* Umrah Du'ās — taller card */}
          <TouchableOpacity
            style={[jn.duaCard, jn.duaCardUmrah]}
          ...
          >
            ...
            >
              ...
              <View style={jn.duaCardContent}>
                <Text style={jn.duaCardEyebrow}>UMRAH</Text>
                <Text style={jn.duaCardTitle}>{"Umrah Du\u02bf\u0101s"}</Text>
                <Text style={jn.duaCardSub}>{"Every du\u02bf\u0101 for every stage"}</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>

          {/* Hajj Du'ās — shorter card */}
          <TouchableOpacity
            style={[jn.duaCard, jn.duaCardHajj]}
          ...
          >
            ...
            >
              <View style={jn.duaCardScrim} />
              <View style={jn.duaCardContent}>
                <Text style={jn.duaCardEyebrow}>HAJJ</Text>
                <Text style={jn.duaCardTitle}>{"Hajj Du\u02bf\u0101s"}</Text>
                <Text style={jn.duaCardSub}>{"From Ihram to Farewell"}</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>
...
const jn = StyleSheet.create({
  ...
  // Umrah + Hajj du'ā cards — side by side, different heights
  duaCardsRow:   { flexDirection:"row", gap:spacing(1.25), marginBottom:spacing(1.5) },
  duaCard:       { flex:1, borderRadius:16, overflow:"hidden", shadowColor:"#1C1408", shadowOffset:{width:0,height:4}, shadowOpacity:0.16, shadowRadius:12, elevation:6 },
  duaCardUmrah:  { height:200 },
  duaCardHajj:   { height:160 },
  ...
  duaCardTitle:  { fontFamily:SERIF, fontSize:18, color:"#fff", fontWeight:"600", marginBottom:2 },
  duaCardSub:    { fontSize:12, color:"rgba(255,255,255,0.72)" },
  heroCardBg:        { flex:1 },
