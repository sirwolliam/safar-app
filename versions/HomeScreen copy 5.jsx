...
const s = StyleSheet.create({
  ...
  // White top fade
  topFade:  { position:"absolute", top:0, left:0, right:0, height:Math.round(HERO_H*0.46), overflow:"hidden" },
  fadeL1:   { flex:2, backgroundColor:"rgba(255,255,255,1.0)" },
  fadeL2:   { flex:1, backgroundColor:"rgba(255,255,255,0.88)" },
  fadeL3:   { flex:1, backgroundColor:"rgba(255,255,255,0.50)" },
  fadeL4:   { flex:1, backgroundColor:"rgba(255,255,255,0.15)" },
