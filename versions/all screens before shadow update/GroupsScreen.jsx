...
export default function GroupsScreen({ navigation }) {
  ...
  const s = useMemo(() => StyleSheet.create({
    ...
    msLink:      { flexDirection:"row", alignItems:"center", gap:spacing(0.75), backgroundColor:C.background, borderRadius:radius.sm, borderWidth:1, borderColor:C.border, padding:spacing(1), marginBottom:spacing(1.25) },
    msLinkTxt:   { flex:1, fontSize:typography.tiny, color:C.primary },
