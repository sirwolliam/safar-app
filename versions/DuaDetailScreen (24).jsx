...
function HeaderPattern({ width, height }) {
  // ViewBox height kept at ~352 (original SVG proportions) so pattern
  // renders at the same visual density as before the fixed-height change.
  // absoluteFill means it covers whatever the headerZone height is.
  return (
    <Svg
      width={width}
      height={height}
      viewBox="0 0 1052.1 352.6"
      ...
      <View style={[s.safe, { paddingBottom: 0 }]}>
        ...
        <View style={[s.ctrlBar, { paddingBottom: spacing(2) + insets.bottom }]}>
          ...
          <View style={s.ctrlRow}>
            ...
            {/* Play / Pause — large white circle, centred */}
...
const s = StyleSheet.create({
  ...
  // Toggles — moved down 10px more (19+10=29)
  togglesRow: {
    flexDirection:"row",
    alignItems:"center",
    justifyContent:"center",
