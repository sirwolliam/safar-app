          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            <ImageBackground
              ...
              <View style={jn.compactCardContent}>
                ...
                <Text style={jn.compactCardArrow}>{"›"}</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>
...
const jn = StyleSheet.create({
  ...
  departureBadge:  { alignItems:"center", backgroundColor:"#C8B89A", borderRadius:radius.md, borderWidth:1, borderColor:"#B0A080", paddingHorizontal:spacing(1.5), paddingVertical:spacing(0.75) },
  departureDays:   { fontFamily:SERIF, fontSize:22, color:"#3C2A14", fontWeight:"400", lineHeight:26 },
  departureLbl:    { fontSize:10, color:"#6A5030", textAlign:"center", lineHeight:13, letterSpacing:0.3 },
  ...
  compactCardContent: { padding:spacing(1.5), flexDirection:"row", alignItems:"flex-end", justifyContent:"space-between" },
  compactCardArrow:   { fontSize:22, color:"rgba(255,255,255,0.7)" },
  compactTitleWhite:  { fontFamily:SERIF, fontSize:17, color:"#fff", fontWeight:"400", marginBottom:3 },
  compactSubWhite:    { fontSize:14, color:"rgba(255,255,255,0.8)", lineHeight:18 },
