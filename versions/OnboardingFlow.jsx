...
const ws = StyleSheet.create({
  ...
  topBar:    { position: "absolute", top: 0, left: 0, right: 0, paddingTop: 56, paddingHorizontal: 24, alignItems: "flex-start" },
  wordmark:  { fontSize: 13, letterSpacing: 4, color: T.gold, fontWeight: "500" },
  content:   {
    position: "absolute", bottom: 0, left: 0, right: 0,
    paddingHorizontal: 28, paddingBottom: 52, paddingTop: 32,
