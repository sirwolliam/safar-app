...
const createStyles = (colors) => StyleSheet.create({
  ...
  emptyBtn: { backgroundColor: "#1E3D30", borderRadius: 10, paddingVertical: 12, paddingHorizontal: 24, ...shadows.button },
  emptyBtnText: { color: "#fff", fontWeight: "500" },

  scroll: { paddingHorizontal: 20 },
  noteCard: {
    backgroundColor: "#E8DDD0", borderRadius: 10, borderWidth: 1,
    borderColor: "#C8BFB2", padding: 16, marginBottom: spacing(1.25), ...shadows.card,
  },
  ...
  notePreview: { fontSize: 14, color: "#3A3530", lineHeight: 20, marginBottom: spacing(0.75) },
  noteDate: { fontSize: typography.tiny, color: "#3A3530" },
});
