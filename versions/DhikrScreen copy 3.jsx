...
const s = StyleSheet.create({
  ...
  selectorInner:   { flex:1 },
  selectorHint:    { fontSize:13, color:GOLD, fontWeight:"700", letterSpacing:1, marginBottom:8 },
  selectorArabic:  { fontFamily:SERIF, fontSize:26, color:WHITE, writingDirection:"rtl", lineHeight:38, marginBottom:4 },
  selectorTranslit:{ fontSize:17, color:GOLD, fontStyle:"italic" },
