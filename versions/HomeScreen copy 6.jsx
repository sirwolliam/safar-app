...
const CONTENT_TILES = [
  { id:"expect", label:"What to Expect", sub:"Learn each step",      screen:"WhatToExpect", image:require("../assets/prepare2.png") },
  { id:"learn",  label:"Practice & Learn", sub:"Audio, recite, repeat", screen:"PracticeLearn", image:require("../assets/journey3.png") },
  { id:"duas",   label:"My Duas",          sub:"Lists you've created",  screen:"Duas",          image:require("../assets/duas2.png") },
];
    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false} bounces>
        ...
        <View style={s.heroWrap}>
          ...
          >
            {/* True gradient fade — transparent at bottom, white at top */}
            <View style={s.fadeWrap} pointerEvents="none">
              <View style={s.fadeTop} />
              <View style={s.fadeMid} />
              <View style={s.fadeBot} />
            </View>

            {/* Soft bottom scrim — only behind greeting text, not too dark */}
...
const s = StyleSheet.create({
  ...
  // Fade layers — use absolute positioning, not flex stacking
  // This gives a true top-to-transparent gradient feel
  fadeWrap: {
    position:"absolute", top:0, left:0, right:0,
    height:Math.round(HERO_H * 0.48),
    flexDirection:"column",
  },
  fadeTop: { flex:3, backgroundColor:"rgba(255,255,255,0.96)" },
  fadeMid: { flex:2, backgroundColor:"rgba(255,255,255,0.55)" },
  fadeBot: { flex:2, backgroundColor:"rgba(255,255,255,0.0)" },

  // Bottom scrim — gentle, only bottom 20%
  bottomScrim: {
    position:"absolute", bottom:0, left:0, right:0,
    height:Math.round(HERO_H * 0.20),
  ...
  heroBottom: {
    ...
    paddingHorizontal:spacing(2.5), paddingBottom:spacing(2.5),
  },
  ...
  planCard: {
    ...
    marginHorizontal:spacing(2.5), marginTop:-spacing(2.5) - 20,
  ...
  actionCard:{ flex:1, flexDirection:"row", alignItems:"center", gap:spacing(1.25), backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, padding:spacing(1.5) },
  actionText:{ flex:1 },
