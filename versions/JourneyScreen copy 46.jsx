...
const sd = StyleSheet.create({
  ...
  line:    { height:1, backgroundColor:"#C8BFB2", marginBottom:14 },
  textWrap:{ },
  label:   { fontFamily:"SourceSerif4-Regular", fontSize:17, color:"#100E0A", fontWeight:"400" },
  sub:     { fontSize:12, color:"#5C534A", fontWeight:"500", marginTop:2, lineHeight:17 },
});
...
const jn = StyleSheet.create({
  ...
  // ── Page header ─────────────────────────────────────────────────────────────
  pageHeader:    { paddingTop:16, paddingBottom:12, paddingHorizontal:2 },
  pageTitleRow:  { flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginBottom:0 },
  pageTitle:     { fontFamily:SERIF, fontSize:28, fontWeight:"400", color:"#100E0A", flex:1, marginBottom:3 },
  ...
  calSheet:        { backgroundColor:"#F5EDE0", borderTopLeftRadius:24, borderTopRightRadius:24, maxHeight:"88%", minHeight:480, paddingHorizontal:20, paddingBottom:24 },
  ...
  calEntryGroupDate:    { fontFamily:SERIF, fontSize:13, color:"#1E3D30", marginBottom:6, paddingBottom:4, borderBottomWidth:1, borderBottomColor:"#DDD5C8" },
  ...
  calEntryTxt:          { flex:1, fontSize:14, color:"#100E0A", lineHeight:20 },
