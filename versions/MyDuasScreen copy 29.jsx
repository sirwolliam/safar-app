...
const tb = StyleSheet.create({
  // Tray — nav shelf behind all three buttons
  tray:     { backgroundColor:colors.card, borderRadius:radius.xl, marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), padding:spacing(1.25), borderWidth:1, borderColor:colors.border, shadowColor:"#8A6A40", shadowOffset:{ width:0, height:4 }, shadowOpacity:0.14, shadowRadius:10, elevation:5 },
  row:      { flexDirection:"row", gap:spacing(1) },
  btn:      { flex:1, backgroundColor:colors.background, borderRadius:radius.md, borderWidth:1, borderColor:colors.border, overflow:"hidden", shadowColor:"#8A6A40", shadowOffset:{ width:0, height:2 }, shadowOpacity:0.10, shadowRadius:5, elevation:3 },
  btnOn:    { borderColor:"#8AB8A0", borderWidth:2, backgroundColor:colors.card, shadowColor:"#2F5D50", shadowOpacity:0.18, shadowRadius:8, elevation:6 },
