...
const s = StyleSheet.create({
  ...
  pickerNote:   { fontSize:11, color:"#6B6259", padding:14, textAlign:"center", lineHeight:16 },

  // Loading / error
  loadingWrap:  { alignItems:"center", paddingVertical:60, gap:16 },
  loadingText:  { fontSize:15, color:"#3D3935" },
  errorWrap:    { alignItems:"center", paddingVertical:40, gap:16 },
  errorText:    { fontSize:15, color:"#3D3935", textAlign:"center", lineHeight:22 },
  ...
  nextCountdown: { fontSize:12, color:"#4A4846" },
  ...
  methodNote:   { fontSize:11, color:"#6B6259", fontWeight:"500", textAlign:"center", lineHeight:17, marginBottom:8 },
});
