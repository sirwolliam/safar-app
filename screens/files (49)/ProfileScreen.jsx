...
const createStyles = (colors) => StyleSheet.create({
  ...
  // Header
  header:         { paddingHorizontal:spacing(2.5), paddingTop:spacing(2), paddingBottom:spacing(1.75), backgroundColor:colors.background },
  headerTitleRow: { flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginBottom:3 },
  headerIcons:    { flexDirection:"row", gap:8 },
  headerIconBtn:  { width:36, height:36, borderRadius:18, backgroundColor:"#F5EDE0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center" },
