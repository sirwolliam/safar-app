...
const sd = StyleSheet.create({
  ...
  sub:     { fontSize:12, color:"#9A8E7A", marginTop:2, lineHeight:17 },
});
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <View style={jn.datesCardWrap}>
          <View style={jn.datesCardTopRow}>
            ...
            {/* Entries chevron — only shown when entries exist */}
            {Object.keys(calEntries).filter(d => (calEntries[d] ?? []).length > 0).length > 0 && (
              <TouchableOpacity style={jn.datesCardChevBtn}
...
const jn = StyleSheet.create({
  ...
  pageSub:       { fontSize:14, color:"#5A5650", lineHeight:20, fontWeight:"400", maxWidth:"68%", marginTop:0 },
  ...
  entriesCardSub:      { fontSize:12, color:"#9A8E7A" },
  ...
  datesCardTopRow:    { flexDirection:"row", alignItems:"stretch" },
  datesCardMain:      { flex:1, flexDirection:"row", alignItems:"center", padding:18, gap:12 },
  datesCardChevBtn:   { justifyContent:"center", alignItems:"center", paddingHorizontal:14, borderLeftWidth:1, borderLeftColor:"#D4D0CA", gap:4 },
  datesCardChevTxt:   { fontSize:12, color:"#5A5650", fontWeight:"600" },
  datesCardChevLabel: { fontSize:10, color:"#9A8E7A" },
  datesEntriesBody:   { borderTopWidth:1, borderTopColor:"#D4D0CA", paddingHorizontal:16 },
  datesEntriesExplainer: { paddingHorizontal:0, paddingVertical:10, backgroundColor:"#F5F2EC", marginHorizontal:-16, marginBottom:8 },
  datesEntriesExplainerTxt: { fontSize:12, color:"#7A7060" },
  ...
  calSheet:        { backgroundColor:"#FDFAF4", borderTopLeftRadius:24, borderTopRightRadius:24, maxHeight:"88%", minHeight:480 },
