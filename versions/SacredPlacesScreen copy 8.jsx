...
const sc = StyleSheet.create({
  ...
  name:       { fontFamily: SERIF, fontSize: 22, color: "#100E0A", marginBottom: 2 },
...
const createStyles = (C) => StyleSheet.create({
  ...
  listTitle:   { fontSize:10, fontWeight:"800", letterSpacing:2, color: C.subtext, letterSpacing:1.5, textTransform:"uppercase", marginBottom:12 },
