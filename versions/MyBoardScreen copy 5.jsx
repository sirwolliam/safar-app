  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.headlineWrap}>
        <Text style={s.headline}>Add a note, task,{"\n"}du\u02bf\u0101\u02be, link, or reminder</Text>
      </View>
...
const s = StyleSheet.create({
  ...
  // Headline CTA
  headlineWrap: { paddingHorizontal:spacing(2.5), paddingBottom:spacing(1.75) },
  headline:     { fontFamily:SERIF, fontSize:26, color:colors.text, lineHeight:34 },
