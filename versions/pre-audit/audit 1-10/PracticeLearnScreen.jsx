...
const createStyles = (colors) => StyleSheet.create({
  ...
  voiceToggle: {
    flex: 1, flexDirection: "row", backgroundColor: "#E8DDD0",
  ...
  stageChip: {
    ...
    borderRadius: 999, borderWidth: 1, borderColor: colors.border, backgroundColor: "#E8DDD0",
  },
  ...
  trackNum: {
    ...
    backgroundColor: "#E8DDD0", borderWidth: 1, borderColor: colors.border,
  },
