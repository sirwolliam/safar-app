...
const fn = StyleSheet.create({
  wrap: {
    ...
    backgroundColor: "#F5EDD8", borderRadius: 10,
    borderWidth: 1, borderColor: "#E8D9B8", padding: 16,
  },
    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.searchWrap}>
        <View style={[s.searchBar, searchFocused && s.searchBarFocused]}>
          ...
          <TextInput
            style={s.searchInput}
            placeholder="Search tools, resources, duas..."
...
const createStyles = (colors) => StyleSheet.create({
  safe:   { flex:1, backgroundColor:"#D4C9B8" },

  // Header
  header:      { paddingHorizontal:20, paddingTop:16, paddingBottom:10, backgroundColor:"#D4C9B8" },
  headerTitle: { fontFamily:SERIF, fontSize:28, fontWeight:"400", color:colors.text, marginBottom:3 },
  headerSub:   { fontSize:14, color:colors.subtext, fontWeight:"400" },

  // Search bar
  searchWrap:        { paddingHorizontal:20, paddingBottom:12 },
  searchBar:         { flexDirection:"row", alignItems:"center", gap:10, backgroundColor:colors.card, borderRadius:14, borderWidth:1.5, borderColor:colors.border, paddingHorizontal:14, paddingVertical:11, shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.08, shadowRadius:4, elevation:2 },
  ...
  tabsWrap:      { marginBottom:0, backgroundColor:"#D4C9B8" },
  ...
  sectionTitle:  { fontFamily:SERIF, fontSize:22, fontWeight:"400", color:colors.text, marginBottom:4 },
  sectionSub:    { fontSize:14, color:colors.subtext, lineHeight:20 },

  // Menu card
  menuCard:      { marginHorizontal:20, backgroundColor:colors.card, borderRadius:16, borderWidth:1, borderColor:colors.border, overflow:"hidden", shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.10, shadowRadius:8, elevation:3 },
  menuRow:       { flexDirection:"row", alignItems:"center", gap:14, paddingHorizontal:18, paddingVertical:16 },
  menuRowBorder: { borderBottomWidth:1, borderBottomColor:colors.border },
  menuIconWrap:  { width:46, height:46, borderRadius:12, backgroundColor:"#EBF2EE", alignItems:"center", justifyContent:"center", flexShrink:0 },
  menuInfo:      { flex:1 },
  ...
  affiliateTile:       { width:(SW - 40 - 12)/2, backgroundColor:colors.card, borderRadius:14, borderWidth:1, borderColor:colors.border, padding:16, gap:4, shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.08, shadowRadius:4, elevation:2 },
