    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false} bounces>
        ...
        <View style={s.heroWrap}>
          ...
          >
            {/* No fade overlays — image is naturally well-lit */}
...
const s = StyleSheet.create({
  ...
  // Hero — reduced height to bring body content into view without scrolling
  heroWrap: {},
  hero:     { width:"100%", height:HERO_H, justifyContent:"space-between" },
  heroImg:  { resizeMode:"cover" },

  // Hero top row — text sits directly over the bright image top area
  heroTopRow: {
    flexDirection:"row",
  ...
  // Hero bottom greeting — text over bright foreground, use dark colour
  heroBottom: {
  ...
  greetText: {
    ...
    textShadowColor:"rgba(255,255,255,0.6)", textShadowOffset:{width:0,height:1}, textShadowRadius:4,
  },

  // Plan card — overlap hero by same amount as before
  planCard: {
  ...
  // Body — marginTop reduced by ~50px to pull tiles and action cards up
  body: { backgroundColor:colors.background, paddingHorizontal:spacing(2.5), paddingTop:spacing(2), marginTop:spacing(0.5) },
  ...
  tileLabel:{ fontFamily:SERIF, fontSize:11, fontWeight:"400", color:colors.text, lineHeight:15, marginBottom:2 },
  tileSub:  { fontSize:10, color:colors.subtext, fontWeight:"300", lineHeight:14 },
