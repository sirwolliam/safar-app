  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── 3. Guide card — launches Umrah or Hajj guide ── */}
        ...
        {/* ── 4. Sacred Places + What to Expect ── */}
...
const jn = StyleSheet.create({
  ...
  // ── 1. My Journey Board — hero card ─────────────────────────────────────────
  boardHero:        { borderRadius:20, overflow:"hidden", height:312, marginBottom:14, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  boardHeroBg:      { flex:1 },
  ...
  halfCard:            { flex:1, borderRadius:16, overflow:"hidden", height:160, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  ...
  compactCard:  { flex:1, justifyContent:"flex-end", backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#D4D0CA", padding:16, height:149, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  ...
  // Old hero/board refs (kept for safety)
