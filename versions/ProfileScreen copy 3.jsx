...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      {/* ── Hero image at very top, above everything ── */}
      <Image
        source={require("../assets/prepare2.png")}
        style={s.heroImage}
        resizeMode="cover"
      />
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        {/* Account & Settings */}
        <SectionHeader styles={s} title="Account & Settings" />
...
const createStyles = (colors) => StyleSheet.create({
  ...
  // Hero — full width at very top, no margin
  heroImage: {
    width: "100%",
    height: HERO_H,
  },

  // Sticky header — outside ScrollView, between hero and scroll
  header: {
  ...
  headerSub:   { fontSize: typography.small, color: colors.subtext, fontWeight: "300", marginTop: 1 },
  ...
  sectionTitle: {
    fontFamily: SERIF, fontSize: typography.heading,
    fontWeight: "400", color: colors.text,
  },
  sectionSub: { fontSize: typography.tiny, color: colors.subtext, marginTop: 2 },

  menuCard: {
    marginHorizontal: spacing(2.5), backgroundColor: colors.card, borderRadius: radius.lg,
  ...
  menuIconWrap: {
    width: 44, height: 44, borderRadius: radius.md, backgroundColor: "#EBF2EE",
  ...
  affiliateDisclosure: {
    ...
    marginHorizontal: spacing(2.5), marginBottom: spacing(1), lineHeight: 16,
  },
  affiliateGrid: {
    flexDirection: "row", flexWrap: "wrap", gap: spacing(1.25),
    paddingHorizontal: spacing(2.5),
  },
  affiliateTile: {
    width: (SW - spacing(2.5) * 2 - spacing(1.25)) / 2,
