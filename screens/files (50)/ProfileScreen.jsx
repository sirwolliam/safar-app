...
const createStyles = (colors) => StyleSheet.create({
  ...
  // Header — fixed 72px, matches all other tabs exactly
  header:         { height:72, paddingHorizontal:spacing(2.5), justifyContent:"center", backgroundColor:colors.background },
  headerLeft:     { flex:1 },
