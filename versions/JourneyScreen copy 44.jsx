...
const jn = StyleSheet.create({
  ...
  pageTitle:     { fontFamily:SERIF, fontSize:28, fontWeight:"400", color:"#1A1712", flex:1 },
  ...
  datesEntriesBody:   { borderTopWidth:1, borderTopColor:"#D4D0CA" },
  datesEntriesExplainer: { paddingHorizontal:16, paddingVertical:10, backgroundColor:"#F5F2EC" },
  ...
  calSheet:        { backgroundColor:"#FDFAF4", borderTopLeftRadius:24, borderTopRightRadius:24 },
