    ...
    <Svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`}>
      <Defs>
        <LinearGradient id="qiblaGrad" x1="0" y1="0" x2="0" y2="1">
          <Stop offset="0%" stopColor="#5FBA8A" stopOpacity="1" />
          <Stop offset="100%" stopColor="#3B8060" stopOpacity="1" />
        </LinearGradient>
      </Defs>

      {/* Outer ring */}
      <Circle cx={CX} cy={CY} r={R} fill="#1A3828" stroke="#1E3D30" strokeWidth={1.5} />
      ...
      {/* Inner circle */}
      <Circle cx={CX} cy={CY} r={R - 50} fill="#163B2E" stroke="#1E3D30" strokeWidth={1} />
...
const s = StyleSheet.create({
  ...
  header:       { backgroundColor:"#4A5C48", minHeight:160, position:"relative", overflow:"hidden", paddingHorizontal:20, paddingBottom:14 },
  ...
  headerSub:    { fontSize:15, color:"#FDFAF4", fontWeight:"500", marginTop:1 },
  ...
  pickerPanel:   { backgroundColor:"#FDFAF4", borderRadius:14, borderWidth:1, borderColor:"#C8BFB2", marginBottom:16, overflow:"hidden", shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:6, elevation:3 },
  ...
  manualToggle:  { paddingHorizontal:16, paddingVertical:12, borderTopWidth:1, borderTopColor:"#C8BFB2" },
  manualToggleTxt:{ fontSize:14, color:"#1E3D30" },
  manualPanel:   { paddingHorizontal:16, paddingBottom:16, gap:8 },
  manualInput:   { backgroundColor:"#E8DDD0", borderRadius:8, borderWidth:1, borderColor:"#C8BFB2", paddingHorizontal:12, paddingVertical:10, fontSize:15, color:"#100E0A" },
  manualBtn:     { backgroundColor:"#1E3D30", borderRadius:8, paddingVertical:12, alignItems:"center", marginTop:4 },
  ...
  numbersCard:   { backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", padding:14, justifyContent:"center", gap:10, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:6, elevation:3, minWidth:110 },
  numberBlock:   { alignItems:"center" },
  numberLabel:   { fontSize:9, fontWeight:"700", letterSpacing:1.5, color:"#5C534A", marginBottom:2 },
  numberValue:   { fontFamily:SERIF, fontSize:22, color:"#1E3D30", lineHeight:26 },
  numberSub:     { fontSize:11, color:"#3A3530", marginTop:1 },
  numberDivider: { height:1, backgroundColor:"#C8BFB2", width:"100%" },

  instructCard:  { flex:1, backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", padding:14, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:6, elevation:3 },
  instructTitle: { fontFamily:SERIF, fontSize:14, color:"#100E0A", marginBottom:6 },
  instructBody:  { fontSize:12, color:"#3A3530", lineHeight:18 },

  noteCard:      { backgroundColor:"#EEE4CB", borderRadius:14, borderWidth:1, borderColor:"#DDD0A8", padding:16, marginBottom:8 },
  noteText:      { fontSize:12, color:"#6B5020", lineHeight:18 },
});
