...
export default function MyDuasScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      {/* Hero — different image per tab */}
      {activeTab === "myLists" && (
        <Image source={require("../assets/tab_my_lists.jpg")} style={s.hero} resizeMode="cover"/>
      )}
      {activeTab === "library" && (
        <Image source={require("../assets/tab_dua_library.jpg")} style={s.hero} resizeMode="cover"/>
      )}
      {activeTab === "shared" && (
        <Image source={require("../assets/tab_shared_duas.jpg")} style={s.hero} resizeMode="cover"/>
      )}
