...
const cf = StyleSheet.create({
  ...
  cardBody:    { fontSize:12, color:"#3D3935", lineHeight:18, marginBottom:4 },
  cardSub:     { fontSize:11, color:"#5A5248", marginTop:4 },
  ...
  checkDone:   { color:"#6B6259", textDecorationLine:"line-through" },
  moreItems:   { fontSize:10, color:"#5A5248", marginTop:2 },
  ...
  progTxt:     { fontSize:10, color:"#5A5248" },
...
const tp2 = StyleSheet.create({
  ...
  sub:       { fontSize:12, color:"#4A4540" },
  manage:    { fontSize:13, color:"#2F5D50", fontWeight:"500" },
  empty:     { fontSize:13, color:"#6B6259", textAlign:"center", paddingHorizontal:16, paddingBottom:16, paddingTop:8, fontStyle:"italic" },
...
const qa = StyleSheet.create({
  ...
  cancel:       { fontSize:15, color:"#3D3935", width:60 },
  ...
  typeLabel:    { fontSize:11, color:"#3D3935" },
  ...
  removeItem:   { fontSize:18, color:"#6B6259", lineHeight:22 },
...
const es = StyleSheet.create({
  ...
  ref:       { fontSize:11, color:"#5A5248" },
  title:     { fontFamily:SERIF, fontSize:20, color:"#1A1712", marginBottom:8, textAlign:"center" },
  body:      { fontSize:15, color:"#4A4540", textAlign:"center", lineHeight:22 },
});
...
const s = StyleSheet.create({
  ...
  headerSub:    { fontSize:13, color:"#5A5248", marginTop:2 },
  ...
  sortTxt:   { fontSize:13, color:"#3D3935" },
