...
const createStyles = (colors) => StyleSheet.create({
  ...
  noteText: { flex: 1, fontSize: 12, color: "#7A6030", lineHeight: 18 },

  bulkRow: {
    flexDirection: "row", alignItems: "center", justifyContent: "space-between",
    paddingHorizontal: spacing(2.5), marginBottom: spacing(1),
  },
  bulkBtn: { fontSize: 14, color: colors.primary, fontWeight: "500" },
  selCount: { fontSize: 14, color: colors.subtext },
  ...
  stageTitle: { flex: 1, fontSize: 16, fontWeight: "500", color: colors.text },
  stageCount: { fontSize: 12, color: colors.subtext },
  ...
  duaTitle: { fontSize: 14, color: colors.text, flex: 1 },
  ...
  shareBtnText: { fontSize: 16, color: colors.text, fontWeight: "400" },
  saveBtn: {
