...
import {
  ...
  Clock, PlayCircle, Wrench, Note, Gear,
      ...
      >
        ...
        <View style={s.pillarsGrid}>
          ...
          >
            ...
            <View style={s.pillarInner}>
              <CompassRose size={22} color="#C8A96A" weight="regular" />
              <View>
          ...
          >
            ...
            <View style={s.pillarInner}>
              <HandsPraying size={22} color="#C8A96A" weight="regular" />
              <View>
                <Text style={s.pillarLabel}>Practise</Text>
          ...
          >
            ...
            <View style={s.pillarInner}>
              <Users size={22} color="#C8A96A" weight="regular" />
              <View>
        ...
        <View style={s.gridWrap}>
          {[
            ...
            { label:"Du\u02bfAs",   Icon:HandsPraying, screen:"Duas",         tab:true  },
            { label:"Guidance",     Icon:BookOpenText, screen:"Guides",       tab:true  },
            { label:"Connect",      Icon:UsersThree,   screen:"Groups",       tab:false },
        ...
        {/* ══════════════════════════════════════════════════════════════════
            MY SHORTCUTS — curated, quiet quick-access tiles
        ══════════════════════════════════════════════════════════════════ */}
        ...
        <View style={s.shortcutsGrid}>
          {[
            ...
            { label:"Guides",       Icon: BookOpen,    screen:"Guides" },
            ...
            <TouchableOpacity
              key={item.label}
              style={s.shortcutTile}
              activeOpacity={0.7}
              onPress={() => navigation?.navigate?.(item.screen)}
            >
              <View style={s.shortcutIconWrap}>
                <item.Icon size={22} color={s.shortcutIconColor.color} weight="regular" />
              </View>
              <Text style={s.shortcutLabel} numberOfLines={1}>{item.label}</Text>
            </TouchableOpacity>
          ))}
        </View>
...
const s = StyleSheet.create({
  ...
  shortcutIconWrap: {
    ...
    height: 50,
    borderRadius: 16,
    backgroundColor: "rgba(74,92,72,0.08)",
    alignItems: "center",
    justifyContent: "center",
    marginBottom: 7,
  },
  shortcutIconColor: { color: "#6A7A66" },
  shortcutLabel: {
    fontSize: 11,
    color: "#6A6256",
    fontWeight: "500",
