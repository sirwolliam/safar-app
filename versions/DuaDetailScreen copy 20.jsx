  ...
  return (
    <>
      <SafeAreaView style={s.safe}>
        ...
        {/* ── Header zone: nav + pattern + arch + star + stage + title + counter ── */}
        <View
          style={s.headerZone}
        ...
        >
          ...
          {/* Nav row lives inside header so star aligns with buttons */}
          <View style={s.topNav}>
          ...
          {/* Star ornament — now vertically near the nav buttons */}
...
const s = StyleSheet.create({
  ...
  // Header zone — contains nav + pattern + arch + title
  headerZone: {
    alignItems:"center",
  ...
  headerStar: { marginTop:4, marginBottom:5 },
  stageLabel: {
    fontSize:11,
    fontWeight:"700",
    color:GOLD,
