...
const TOOLS = [
  ...
  { id: "qibla",     label: "Qibla",                   sub: "Find the direction of the Kabah",        Icon: Compass,          screen: "Qibla"            },
  { id: "currency",  label: "Currency",                 sub: "Live exchange rates for your trip",           Icon: CurrencyDollar,   screen: "CurrencyConverter"},
  { id: "tawaf",     label: "Tawaf Counter",  sub: "Track your seven circuits",                   Icon: ArrowsClockwise,  screen: "Tawaf"            },
  { id: "saiy",      label: "Say Tracker",        sub: "Safa to Marwah, seven times",       Icon: PersonSimpleWalk, screen: "Saiy"             },
