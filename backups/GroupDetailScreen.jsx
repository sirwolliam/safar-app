  ...
  return (
    <View style={mc.card}>
      ...
      <View style={mc.footer}>
        <TouchableOpacity
          style={hasAmeen ? [mc.ameenBtn, mc.ameenBtnActive] : mc.ameenBtn}
          onPress={handleAmeen}
        ...
        >
          {adding
            ...
            : <>
                ...
                <Text style={hasAmeen ? [mc.ameenText, mc.ameenTextActive] : mc.ameenText}>
        ...
        <View style={pm.overlay}>
          <View style={pm.sheet}>
            ...
            <View style={pm.btnRow}>
              ...
              <TouchableOpacity
                style={(!postText.trim() || posting) ? [pm.submitBtn, pm.submitBtnDisabled] : pm.submitBtn}
                onPress={handlePost}
