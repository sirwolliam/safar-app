...
const LIBRARY_CATEGORIES = [
  ...
  { id:"patience",   name:"Patience & Strength",    count:19, emoji:"\uD83C\uDF31", shade:"#C8C090" },
  { id:"provision",  name:"Provision & Rizq",       count:17, emoji:"\u2728",       shade:"#B8C8A8" },
  { id:"healing",    name:"Healing & Health",       count:14, emoji:"\uD83E\uDE79", shade:"#C8A8A8" },
  { id:"anxiety",    name:"Anxiety & Worry",        count:16, emoji:"\uD83D\uDE4F", shade:"#B8B8C8" },
  { id:"travel",     name:"Travel & Safety",        count:12, emoji:"\uD83D\uDEEB", shade:"#C8D4A8" },
  { id:"morning",    name:"Morning & Evening",      count:22, emoji:"\uD83C\uDF05", shade:"#F0D8A8" },
  { id:"parents",    name:"Parents & Family",       count:11, emoji:"\uD83D\uDC68\u200D\uD83D\uDC69\u200D\uD83D\uDC67", shade:"#D4B8C8" },
  { id:"repentance", name:"Repentance & Tawbah",    count:13, emoji:"\uD83C\uDF3A", shade:"#C8C8A0" },
  { id:"salah",      name:"Prayer & Salah",         count:15, emoji:"\uD83D\uDCFF", shade:"#A8C0C8" },
  { id:"quran",      name:"Quranic Duas",           count:28, emoji:"\uD83D\uDCD6", shade:"#A8B4C0" },
  { id:"hajj",       name:"Hajj & Umrah",           count:31, emoji:"\uD83D\uDD4B", shade:"#B4C4A8" },
  { id:"entering",   name:"Entering & Leaving",     count:10, emoji:"\uD83D\uDEAA", shade:"#C4B8A8" },
];
