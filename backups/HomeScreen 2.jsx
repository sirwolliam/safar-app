...
const s = StyleSheet.create({
  ...
  pillarCardLearn:    { backgroundColor: "#3D5C48" },
  pillarCardPractice: { backgroundColor: "#5C4A28" },
  pillarCardPlan:     { backgroundColor: "#3A4A5C" },
  pillarCardConnect:  { backgroundColor: "#4A3850" },
