...
const tb = StyleSheet.create({
  ...
  // Image area — 30% taller than before (72 -> 94)
  imgWrap:  { width:"100%", height:94, position:"relative" },
  img:      { width:"100%", height:"100%" },
  imgScrim: { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(47,93,80,0.25)" },

  // Text area — bigger text (+4pt each)
  textWrap: { padding:spacing(1.25), paddingTop:spacing(1) },
  label:    { fontFamily:SERIF, fontSize:16, color:colors.text, lineHeight:20, marginBottom:2 },
  labelOn:  { color:colors.primary, fontWeight:"600" },
  sub:      { fontSize:14, color:colors.subtext, lineHeight:18 },
