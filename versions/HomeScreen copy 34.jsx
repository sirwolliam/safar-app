  ...
  return (
    <SafeAreaView style={s.safe}>
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
        ...
        {/* ── Greeting — between hero and card ── */}
        <View style={s.greetingStrip}>
          <Text style={s.greetingSalam}>{"As-salāmu ʿalaykum"}</Text>
          {userName ? (
            <Text style={s.greetingName}>{userName}</Text>
          ) : (
            <Text style={s.greetingName}>{"Welcome to Safar"}</Text>
          )}
        </View>

        {/* ── Departure card — 1/3 overlapping hero ── */}
        <View style={s.heroWrap2}>
...
const s = StyleSheet.create({
  ...
  heroWrap2: { marginTop:-44, paddingBottom:8, zIndex:5 },
  hero:     { height:HERO_H, position:"relative", overflow:"hidden" },
  heroSlide:      { width:SW, height:HERO_H },
  heroSlideBg:    { flex:1 },
  heroSlideContent:{ position:"absolute", bottom:90, left:20, right:20 },
  ...
  heroDots:       { position:"absolute", bottom:14, left:0, right:0, flexDirection:"row", justifyContent:"center", gap:6, alignItems:"center" },
  ...
  // Greeting
  heroGreeting:      { position:"absolute", top:16, left:68, right:64 },
  // NOTE: greeting now top-aligned so slide feature text can show at bottom
  heroSalam:         { fontSize:13, color:"rgba(255,255,255,0.75)", fontWeight:"500", letterSpacing:0.5, marginBottom:3 },
