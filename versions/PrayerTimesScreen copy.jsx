...
const s = StyleSheet.create({
  ...
  // Next prayer — compact horizontal row
  nextHero:      { flexDirection:"row", alignItems:"center", justifyContent:"space-between", backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#D4D0CA", paddingHorizontal:20, paddingVertical:16, marginBottom:10, shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.08, shadowRadius:4, elevation:2 },
  nextLeft:      { flex:1 },
  nextLabel:     { fontSize:9, fontWeight:"700", letterSpacing:2, color:"#9A8E7A", marginBottom:4 },
  nextName:      { fontFamily:SERIF, fontSize:26, color:"#1A1712", fontWeight:"400", lineHeight:30, marginBottom:2 },
  nextArabic:    { fontSize:16, color:"#2F5D50", marginBottom:4 },
  nextTime:      { fontFamily:SERIF, fontSize:36, color:"#2F5D50", fontWeight:"300", letterSpacing:0.5 },
  nextCountdown: { fontSize:12, color:"#7A7670" },

  // Times card
  timesCard:    { backgroundColor:"#FDFAF4", borderRadius:20, borderWidth:1, borderColor:"#D4D0CA", overflow:"hidden", marginBottom:10, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.10, shadowRadius:8, elevation:3 },
  timeRow:      { flexDirection:"row", alignItems:"center", paddingHorizontal:20, paddingVertical:11 },
  ...
  prayerName:   { fontFamily:SERIF, fontSize:15, color:"#1A1712" },
  prayerTime:   { fontSize:20, color:"#1A1712", fontWeight:"300", letterSpacing:0.5 },
