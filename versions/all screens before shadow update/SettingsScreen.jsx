...
const sr = StyleSheet.create({
  row:       { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingHorizontal:spacing(2), paddingVertical:spacing(1.75) },
  rowBorder: { borderBottomWidth:1, borderBottomColor:colors.border },
  info:      { flex:1, paddingRight:spacing(1) },
  label:     { fontFamily:SERIF, fontSize:typography.body, color:colors.text, marginBottom:2 },
...
const createStyles = (colors) => StyleSheet.create({
  ...
  version:      { fontSize:typography.tiny, color:colors.border, textAlign:"center", marginTop:spacing(3), fontWeight:"300" },
});
