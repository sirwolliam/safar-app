      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }}>
        ...
        <View style={jn.modeWrap}>
          <View style={jn.modeRow}>
            {[{key:"umrah",emoji:"\uD83D\uDD4B",name:"Umrah",sub:"Short sacred pilgrimage, any time of year"},{key:"hajj",emoji:"\u26F0\uFE0F",name:"Hajj",sub:"Annual pilgrimage, Dhul Hijjah \u2014 obligatory once in a lifetime"}].map(m => (
        ...
        {/* ── Link cards — individual with subtitle + right-aligned counter ── */}

        {/* Step-by-step Guide */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("StepGuide",{mode,steps:steps.length,completed:completedCount})} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDCCB"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>Step-by-step Guide</Text>
            <Text style={jn.linkSub}>{"Track each step of your " + (mode === "umrah" ? "Umrah" : "Hajj") + " journey"}</Text>
          </View>
          <View style={jn.linkCounter}>
            <Text style={jn.linkCounterNum}>{completedCount}</Text>
            <Text style={jn.linkCounterOf}>{"of " + steps.length}</Text>
          </View>
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>

        {/* Sacred Places Map */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("Map")} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDDFA\uFE0F"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>Sacred Places Map</Text>
            <Text style={jn.linkSub}>Explore duas for each sacred location</Text>
          </View>
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>

        {/* What to Expect */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("WhatToExpect")} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDCD6"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>What to Expect</Text>
            <Text style={jn.linkSub}>Tips to help you plan, prepare and stay organised</Text>
          </View>
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>

        {/* My Journey Board */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("MyBoard")} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDCCC"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>My Journey Board</Text>
            <Text style={jn.linkSub}>Build a custom board of what matters to you</Text>
          </View>
          {boardChecklist > 0 ? (
            <View style={jn.linkCounter}>
              <Text style={jn.linkCounterNum}>{boardDone}</Text>
              <Text style={jn.linkCounterOf}>{"of " + boardChecklist}</Text>
            </View>
          ) : null}
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>
        ...
        {/* My Groups */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("Groups")} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDC65"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>My Groups</Text>
            <Text style={jn.linkSub}>Share milestones with your pilgrimage family</Text>
          </View>
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>

        {/* My Contacts */}
        <TouchableOpacity style={jn.linkCard} onPress={() => navigation?.navigate?.("MyContacts")} activeOpacity={0.85}>
          <View style={jn.linkIconWrap}><Text style={jn.linkIcon}>{"\uD83D\uDC64"}</Text></View>
          <View style={jn.linkInfo}>
            <Text style={jn.linkLabel}>My Contacts</Text>
            <Text style={jn.linkSub}>Store your important contacts in one place</Text>
          </View>
          {contacts.length > 0 ? (
            <View style={jn.linkCounter}>
              <Text style={jn.linkCounterNum}>{contacts.length}</Text>
              <Text style={jn.linkCounterOf}>{contacts.length === 1 ? "contact" : "contacts"}</Text>
            </View>
          ) : null}
          <Text style={jn.linkArrow}>{"\u203a"}</Text>
        </TouchableOpacity>
...
const jn = StyleSheet.create({
  ...
  modeSub:       { fontSize:12, color:colors.subtext, fontWeight:"400" },
  modeSubActive: { color:colors.primary, fontWeight:"400" },
  ...
  progressSub:    { fontSize:typography.small, color:colors.subtext, fontWeight:"400" },
  ...
  linkCounterOf: { fontSize:10, color:colors.subtext, fontWeight:"400", textAlign:"center" },
});
