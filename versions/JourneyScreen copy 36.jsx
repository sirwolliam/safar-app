      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <TouchableOpacity style={jn.datesCard} onPress={() => setShowCalendar(true)} activeOpacity={0.88}>
          <View style={jn.datesCardLeft}>
            ...
            <Text style={jn.datesCardSub}>Set your departure and follow key Hajj dates</Text>
          </View>
        ...
        <Modal visible={showCalendar} animationType="slide" transparent
          ...
          <KeyboardAvoidingView style={{ flex:1 }} behavior={Platform.OS==="ios" ? "padding" : "height"}>
            ...
            <TouchableOpacity style={jn.calOverlay} activeOpacity={1}
              ...
              <TouchableOpacity style={jn.calSheet} activeOpacity={1} onPress={() => {}}>
                ...
                <ScrollView style={jn.calBottom} keyboardShouldPersistTaps="handled">
                  ...
                  {addingEntry && (
                    <View style={jn.calEntryInputWrap}>
                      <Text style={jn.calEntryDateHdr}>
                        {new Date(addingEntry + "T00:00:00").toLocaleDateString("en-GB", { weekday:"short", day:"numeric", month:"long" })}
                      </Text>
                  ...
                  {/* All entries list — grouped by date */}
