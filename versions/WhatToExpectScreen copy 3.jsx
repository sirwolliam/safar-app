...
const TYPE_LABELS = {
  official:  { label: "Official",   color: colors.primary,  bg: "#E2EDE6" },
...
const create_ac = (colors) => StyleSheet.create({
  wrap: {
    marginHorizontal: 20, backgroundColor: colors.card, borderRadius: 10,
...
const create_nl = (colors) => StyleSheet.create({
  ...
  arrow: { fontSize: 14, color: colors.primary },
});
...
const createStyles = (colors) => StyleSheet.create({
  ...
  tabLabel: { fontSize: 14, color: colors.subtext },
  tabLabelActive: { color: "#fff", fontWeight: "500" },

  intro: {
    fontSize: 12, color: colors.subtext, lineHeight: 18,
  ...
  disclaimerLink: { fontSize: 12, color: colors.primary, fontWeight: "500" },
});
