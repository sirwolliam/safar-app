...
export const palette = {
  ...
  forest300: "#708C6C",
  forest400: "#596E55",
  forest500: "#4A5C48",   // primary — sage green
  forest600: "#3A4A38",
  forest700: "#28352A",
...
export const colors = {
  // Surfaces
  background: palette.parchment200,   // deepened for card contrast (#EDE6D8)
  ...
  // Borders
  border: palette.ink200,             // crisper card edges (#D4D0CA)
...
export const typography = {
  ...
  title:   22,
  display: 28,
  arabic:  28,   // was 26 — more presence on dua cards
  ...
  // Weights
  light:    "400",   // bumped from 300 for legibility
  regular:  "400",
  medium:   "500",
  semibold: "600",
  bold:     "700",
  heading:  "600",   // for section titles and card titles — adds authority
};
