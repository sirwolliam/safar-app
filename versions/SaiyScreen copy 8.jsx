      ...
      <View style={[s.graphicWrap, { width:GRAPHIC_W }]}>
        ...
        <View style={s.middleRow}>
          <View style={s.arrowWrap}>
            <Text style={[s.arrow, { color: destination === "SAFA" ? GREEN_LITE : "rgba(90,140,74,0.30)" }]}>{"↓"}</Text>
          </View>
          <TouchableOpacity
          ...
          <View style={s.arrowWrap}>
            <Text style={[s.arrow, { color: destination === "MARWAH" ? GREEN_LITE : "rgba(90,140,74,0.30)" }]}>{"↑"}</Text>
          </View>
        </View>
