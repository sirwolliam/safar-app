            ...
            <ImageBackground
              ...
              <View style={jn.compactCardContent}>
                <View>
                  ...
                  <Text style={jn.compactSubWhite}>Share milestones and updates</Text>
                </View>
            ...
            <ImageBackground
              ...
              <View style={jn.compactCardContent}>
                <View>
                  ...
                  <Text style={jn.compactSubWhite}>{"Save your\nimportant contacts"}</Text>
                </View>
                <Text style={jn.compactCardArrow}>{"›"}</Text>
              </View>
            </ImageBackground>
...
const jn = StyleSheet.create({
  ...
  compactCardScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(240,230,210,0.18)" },
  compactCardContent: { padding:spacing(1.5), flexDirection:"row", alignItems:"flex-end", justifyContent:"space-between" },
  compactCardArrow:   { fontSize:22, color:"#3C3428" },
  compactTitleWhite:  { fontFamily:SERIF, fontSize:17, color:"#1A1712", fontWeight:"500", marginBottom:3 },
  compactSubWhite:    { fontSize:14, color:"#3C3428", lineHeight:18 },
