...
const s = StyleSheet.create({
  ...
  // Banner CTA
  banner:       { flexDirection:"row", alignItems:"center", justifyContent:"space-between", backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), paddingVertical:spacing(1.5), paddingHorizontal:spacing(2), ...shadows.card },
  bannerTxt:    { fontFamily:SERIF, fontSize:15, color:colors.text, flex:1 },
  bannerArrow:  { fontSize:20, color:colors.subtext },
