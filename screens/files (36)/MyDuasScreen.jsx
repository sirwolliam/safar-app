...
const tb = StyleSheet.create({
  ...
  iconWrapActive: { backgroundColor:"#1E3D30" },
    ...
    <SafeAreaView style={s.safe}>
      ...
      {activeTab === "library" && (
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
          ...
          {/* Category search — plain text filter */}
          <View style={s.searchBar}>
            <Text style={s.searchIcon}>{"\uD83D\uDD0D"}</Text>
            <TextInput style={s.searchInput} placeholder="Filter categories…"
...
const s = StyleSheet.create({
  ...
  arabicBg:    { position:"absolute", right:-8, top:-4, fontSize:108, color:"#1E3D30", opacity:0.06, lineHeight:128, fontWeight:"400" },
  ...
  // AI Du'ā Assistant
  aiSearchWrap:    { marginHorizontal:16, marginBottom:12 },
  ...
  aiDot:           { width:8, height:8, borderRadius:4, backgroundColor:"#1E3D30" },
  ...
  aiSendBtn:       { width:30, height:30, borderRadius:15, backgroundColor:"#1E3D30", alignItems:"center", justifyContent:"center" },
  ...
  aiDotSmall:      { width:7, height:7, borderRadius:3.5, backgroundColor:"#1E3D30" },
  aiResultLabel:   { flex:1, fontSize:12, color:"#1E3D30", fontWeight:"700", letterSpacing:0.3 },
