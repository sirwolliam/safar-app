...
function TabBar({ active, onSelect }) {
  return (
    <View style={tb.row}>
      {[
        { key:"myLists", label:"My Dua Lists",  sub:"Lists you\u2019ve saved" },
...
const tb = StyleSheet.create({
  ...
  btn:    { flex:1, backgroundColor:"#EBF2EE", borderRadius:radius.md, borderWidth:1.5, borderColor:"#C8DDD0", padding:spacing(1.5), alignItems:"center", gap:4 },
