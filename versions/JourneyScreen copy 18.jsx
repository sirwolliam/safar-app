...
const jn = StyleSheet.create({
  ...
  departureBadge:  { alignItems:"center", paddingHorizontal:spacing(1.5), paddingVertical:spacing(0.75) },
  ...
  boardCardBg:     { flex:1 },
  boardScrim:      { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.28)" },
  ...
  halfCardScrim:     { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.28)" },
  ...
  compactCardScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.22)" },
