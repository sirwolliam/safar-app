        ...
        {unpinned.length > 0 ? (
          <>
            <View style={s.allHeader}>
              <View style={s.allTitleRow}>
                <View style={s.allBar} />
                <Text style={s.allTitle}>ALL ITEMS</Text>
                <View style={s.allLine} />
...
const s = StyleSheet.create({
  ...
  // All items section
  allHeader:   { paddingHorizontal:20, marginBottom:12, marginTop:4 },
  allTitleRow: { flexDirection:"row", alignItems:"center", gap:10, marginBottom:8 },
  allBar:      { width:3, height:20, borderRadius:2, backgroundColor:"#1E3D30" },
  allTitle:    { fontFamily:"SourceSerif4-Regular", fontSize:13, fontWeight:"700", letterSpacing:1.5, color:"#1E3D30" },
  allLine:     { flex:1, height:1, backgroundColor:"#C8BFB2" },
