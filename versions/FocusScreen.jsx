    ...
    return (
      <SafeAreaView style={s.safe}>
        <View style={s.pickerWrap}>
          <Text style={s.pickerTitle}>Select your ritual</Text>
    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <View style={s.headerCenter}>
          ...
          <Text style={s.headerSub}>Stay present. You're doing great.</Text>
        </View>
      ...
      {/* Change ritual link */}
      <TouchableOpacity style={s.changeRitual} onPress={() => setShowPicker(true)}>
        <Text style={s.changeRitualText}>Switching to {mode === "Tawaf" ? "Saʿi" : "Tawaf"}?  Change ritual →</Text>
      </TouchableOpacity>
      ...
      <View style={s.dots}>
        {Array.from({ length: config.total }, (_, i) => (
          <TouchableOpacity key={i} style={[s.dot, i + 1 === current && s.dotActive]}
            onPress={() => setCurrent(i + 1)}>
            <Text style={[s.dotLabel, i + 1 === current && s.dotLabelActive]}>{i + 1}</Text>
          </TouchableOpacity>
        ))}
      </View>
      ...
      {/* Footer */}
      <View style={s.footer}>
        <Text style={s.footerText}>♡  Take your time. Every step is an act of worship.</Text>
      </View>
...
const createStyles = (colors) => StyleSheet.create({
  ...
  headerSub: { fontSize: typography.tiny, color: colors.subtext, marginTop: 2 },

  changeRitual: { alignItems: "center", marginBottom: spacing(1) },
  changeRitualText: { fontSize: typography.tiny, color: colors.primary },
