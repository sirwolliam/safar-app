...
const hb = StyleSheet.create({
  wrap:    { marginHorizontal:20, borderRadius:20, overflow:"hidden", height:148, marginBottom:14, shadowColor:"#1A1712", shadowOffset:{width:0,height:4}, shadowOpacity:0.12, shadowRadius:12, elevation:5 },
  bg:      { flex:1 },
  ...
  quote:   { fontFamily:SERIF, fontSize:28, color:"#1A1712", lineHeight:35, maxWidth:"62%" },
  sub:     { height:0 },
});
