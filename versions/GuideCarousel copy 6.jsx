...
function Slide({ step, total, guideTitle }) {
  return (
    <View style={sl.slide}>
      ...
      {/* Top: step circle + guide title below it */}
      <View style={sl.topContent}>
        {/* Green circle with step label */}
        ...
        {/* Guide title below circle */}
        <Text style={sl.guideTitle}>{guideTitle.toUpperCase()}</Text>
      </View>

      {/* Step content — centred in lower portion */}
      ...
      {/* Source — rounded box, 30% black opacity */}
...
const sl = StyleSheet.create({
  ...
  // Top content — step circle + guide title
  topContent: { position:"absolute", top:64, left:0, right:0, alignItems:"center" },

  // Green circle step indicator
  ...
  stepCircleNum:  { fontSize:14, fontWeight:"800", color:"#fff", lineHeight:18 },
  stepCircleSep:  { fontSize:12, color:"rgba(255,255,255,0.50)", lineHeight:18 },
  stepCircleTotal:{ fontSize:12, color:"rgba(255,255,255,0.50)", lineHeight:18 },

  // Guide title — below circle
  guideTitle: { fontSize:11, fontWeight:"800", letterSpacing:3, color:"#C8A96A" },

  // Mid content — step text
  midContent: { position:"absolute", top:SH * 0.44, left:0, right:0, paddingHorizontal:28, alignItems:"center" },
