      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <View style={jn.compactRow}>
          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            activeOpacity={0.88}>
            <ImageBackground
              source={require("../assets/groups_card.jpg")}
              style={jn.compactCardBg}
              imageStyle={{ resizeMode:"cover" }}>
              <View style={jn.compactCardScrim} />
              <View style={jn.compactCardContent}>
                <Text style={jn.compactTitleWhite}>My Groups</Text>
                <Text style={jn.compactSubWhite}>Share milestones</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            activeOpacity={0.88}>
            <ImageBackground
              source={require("../assets/contacts_card.jpg")}
              style={jn.compactCardBg}
              imageStyle={{ resizeMode:"cover" }}>
              <View style={jn.compactCardScrim} />
              <View style={jn.compactCardContent}>
                <Text style={jn.compactTitleWhite}>My Contacts</Text>
                <Text style={jn.compactSubWhite}>Save your important contacts</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>
...
const jn = StyleSheet.create({
  ...
  departureBadge:  { alignItems:"center", backgroundColor:colors.card, borderRadius:radius.md, borderWidth:1, borderColor:colors.border, paddingHorizontal:spacing(1.5), paddingVertical:spacing(0.75), ...shadows.card },
  departureDays:   { fontFamily:SERIF, fontSize:22, color:colors.primary, fontWeight:"400", lineHeight:26 },
  ...
  modeOpt:         { flex:1, alignItems:"center", paddingVertical:spacing(1.25), borderRadius:radius.md, gap:3 },
  modeOptActive:   { backgroundColor:colors.primary },
  modeName:        { fontFamily:SERIF, fontSize:14, color:colors.subtext, fontWeight:"400", letterSpacing:1 },
  ...
  heroProgWrap:      { backgroundColor:"rgba(47,93,80,0.45)", borderRadius:radius.md, padding:spacing(1.25) },
  ...
  boardCardBg:     { flex:1 },
  boardScrim:      { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.48)" },
  ...
  boardTitle:      { fontFamily:SERIF, fontSize:18, color:"#fff", fontWeight:"400", marginBottom:3 },
  boardSub:        { fontSize:12, color:"rgba(255,255,255,0.68)", marginBottom:spacing(1.25) },
  ...
  halfCardScrim:     { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.48)" },
  halfCardOverlay:   { padding:spacing(1.5) },
  halfCardCount:     { fontFamily:SERIF, fontSize:26, color:"#fff", fontWeight:"400", lineHeight:30 },
  halfCardCategory:  { fontSize:9, fontWeight:"700", letterSpacing:1.8, color:"rgba(255,255,255,0.65)", marginBottom:4 },
  halfCardTitleWhite:{ fontFamily:SERIF, fontSize:15, color:"#fff", fontWeight:"400", marginBottom:2 },
  halfCardSubWhite:  { fontSize:11, color:"rgba(255,255,255,0.72)" },

  // ── 5. Compact image cards: Groups + Contacts ─────────────────────────────────
  compactRow:         { flexDirection:"row", gap:spacing(1.25), marginBottom:spacing(1.5) },
  compactCard:        { flex:1, borderRadius:radius.lg, overflow:"hidden", height:110, ...shadows.card },
  compactCardBg:      { flex:1, justifyContent:"flex-end" },
  compactCardScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.38)" },
  compactCardContent: { padding:spacing(1.5) },
  compactTitleWhite:  { fontFamily:SERIF, fontSize:14, color:"#fff", fontWeight:"400", marginBottom:2 },
  compactSubWhite:    { fontSize:11, color:"rgba(255,255,255,0.75)", lineHeight:15 },
