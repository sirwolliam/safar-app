    ...
    <SafeAreaView style={s.safe}>
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false} bounces>
        ...
        <View style={s.heroWrap}>
          ...
          >
            {/* White fade at top — seamless blend with SafeAreaView bg */}
            <View style={s.topFade} pointerEvents="none">
              <View style={s.topFadeL1} />
              <View style={s.topFadeL2} />
              <View style={s.topFadeL3} />
              <View style={s.topFadeL4} />
            </View>
        ...
        <View style={s.body}>
          ...
          {/* ── Connect section — sage green band for Groups + Focus ── */}
...
const s = StyleSheet.create({
  ...
  // White fade at the very top — seamless bleed into SafeAreaView bg
  topFade: {
    position:"absolute", top:0, left:0, right:0,
    height:Math.round(HERO_H * 0.32),
    // Four stacked layers: fully white at top, fully transparent at bottom
  },
  topFadeL1: { flex:3, backgroundColor:"rgba(255,255,255,1.0)" },
  topFadeL2: { flex:2, backgroundColor:"rgba(255,255,255,0.72)" },
  topFadeL3: { flex:2, backgroundColor:"rgba(255,255,255,0.30)" },
  topFadeL4: { flex:2, backgroundColor:"rgba(255,255,255,0.0)" },

  // Hero top row — sits inside the white fade so text is on white
  heroTopRow: {
    flexDirection:"row",
  ...
  greetText: {
    fontFamily:SERIF, fontSize:typography.title, color:colors.text,
    textShadowColor:"rgba(255,255,255,0.7)", textShadowOffset:{width:0,height:1}, textShadowRadius:4,
  },
  ...
  body: { backgroundColor:colors.background, paddingHorizontal:spacing(2.5), paddingTop:spacing(1.75), marginTop:spacing(0.5) },
  ...
  // Connect section — full-bleed sage band wrapping action cards
  connectSection: {
