...
const ml = StyleSheet.create({
  ...
  input:       { backgroundColor:"#E8DDD0", borderRadius:10, borderWidth:1, borderColor:"#D4D0CA", paddingHorizontal:14, paddingVertical:10, fontSize:16, color:"#1A1712", marginBottom:16,
    shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.22, shadowRadius:8, elevation:4,},
...
const createStyles = (colors) => StyleSheet.create({
  ...
  header: { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingHorizontal:spacing(2.5), paddingTop:16, paddingBottom:spacing(1.5) },
  back:        { fontSize:22, color:"#100E0A" },
  headerTitle: { fontFamily:SERIF, fontSize:22, color:"#100E0A" },
  addBtn:      { width:36, height:36, borderRadius:18, backgroundColor:"#1E3D30", alignItems:"center", justifyContent:"center", ...shadows.button },
  addBtnText:  { fontSize:22, color:"#fff", lineHeight:26 },

  tabs: { flexDirection:"row", marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), backgroundColor:"#E8DDD0", borderRadius:radius.md, padding:3, borderWidth:1, borderColor:"#B0ACA0",
    ...shadows.card,},
  tab:          { flex:1, paddingVertical:spacing(1.25), borderRadius:radius.sm, alignItems:"center" },
  tabActive:    { backgroundColor:"#1E3D30" },
  tabLabel:     { fontSize:15, color:"#3A3530", fontWeight:"400" },
  ...
  emptyBody:  { fontSize:16, color:"#3A3530", textAlign:"center", lineHeight:22 },

  scroll:       { paddingHorizontal:spacing(2.5) },
  stageSection: { marginBottom:16 },
  stageLabel:   { fontFamily:SERIF, fontSize:typography.small, fontWeight:"600", color:colors.accent, letterSpacing:1, marginBottom:8, marginTop:spacing(1.5) },
  card:         { backgroundColor:"#E8DDD0", borderRadius:radius.lg, borderWidth:1, borderColor:"#B0ACA0", overflow:"hidden", ...shadows.card },

  duaRow:       { flexDirection:"row", alignItems:"center", gap:spacing(1.5), paddingHorizontal:16, paddingVertical:spacing(1.75) },
  duaRowBorder: { borderBottomWidth:1, borderBottomColor:"#C8BFB2" },
  duaInfo:      { flex:1 },
  duaTitle:     { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:3 },
  duaArabic:    { fontSize:15, color:"#3A3530", textAlign:"right" },
  ...
  shareHintTitle:{ fontFamily:SERIF, fontSize:typography.small, color:"#100E0A", marginBottom:2 },
  shareHintBody: { fontSize:typography.tiny, color:"#3A3530", lineHeight:16 },
  shareHintBtn:  { backgroundColor:"#1E3D30", borderRadius:radius.md, paddingHorizontal:spacing(1.5), paddingVertical:spacing(0.75), ...shadows.button },
  shareHintBtnText:{ fontSize:typography.small, color:"#fff", fontWeight:"600" },

  // Link rows
  linkRow:       { flexDirection:"row", alignItems:"center" },
  linkRowBorder: { borderBottomWidth:1, borderBottomColor:"#C8BFB2" },
  linkMain:      { flex:1, flexDirection:"row", alignItems:"center", gap:spacing(1.5), paddingHorizontal:16, paddingVertical:spacing(1.75) },
  linkIconWrap:  { width:38, height:38, borderRadius:radius.sm, backgroundColor:"#E8DDD0", borderWidth:1, borderColor:"#B0ACA0", alignItems:"center", justifyContent:"center", flexShrink:0 },
  linkIcon:      { fontSize:16 },
  linkInfo:      { flex:1 },
  linkTitle:     { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:2 },
  linkNote:      { fontSize:typography.tiny, color:"#3A3530", marginBottom:1 },
  linkUrl:       { fontSize:typography.tiny, color:"#1E3D30" },
  linkArrow:     { fontSize:16, color:"#1E3D30" },
  linkDelete:    { paddingHorizontal:16, paddingVertical:16 },
  linkDeleteIcon:{ fontSize:13, color:"#C8BFB2" },

  linksFooter: { fontSize:typography.tiny, color:"#3A3530", textAlign:"center", lineHeight:18, marginTop:16, marginHorizontal:spacing(2.5) },
});
