...
const createStyles = (colors) => StyleSheet.create({
  ...
  sarCard: {
    ...
    justifyContent: "space-between", marginBottom: 8, ...shadows.button,
  },
  ...
  statusOnline:  { fontSize: 12, color: colors.subtext },
  ...
  currencyName: { fontSize: 12, color: colors.subtext, marginTop: 2 },
  amountWrap: { alignItems: "flex-end", minWidth: 100 },
  amount: { fontFamily: SERIF, fontSize: 18, color: colors.text },
  rateHint: { fontSize: 10, color: colors.subtext, marginTop: 2 },
  foreignInput: {
    fontFamily: SERIF, fontSize: 18, color: colors.primary,
    textAlign: "right", minWidth: 100,
  ...
  quickBtn: {
    ...
    borderWidth: 1, borderColor: colors.border, backgroundColor: "#E8DDD0",
  ...
  quickBtnText: { fontSize: 14, color: colors.subtext },
  quickBtnTextActive: { color: "#fff", fontWeight: "500" },

  disclaimer: {
    fontSize: 12, color: colors.subtext, fontStyle: "italic",
