...
import {
  ...
  UsersThree, ShareNetwork, AddressBook, ImageSquare, ShareFat,
} from "phosphor-react-native";

const SERIF = "SourceSerif4-Regular";
const ICON_BG = "#3D2240";
const HEADER_IMAGE = require("../assets/hub-headers/connect-header.png");
const GRADIENT = ["transparent", "transparent", "rgba(34,24,32,0.68)", "rgba(34,24,32,0.96)"];
const GRADIENT_LOCS = [0, 0.44, 0.72, 1];

const ROWS = [
  { key: "groups",      Icon: UsersThree,   label: "Groups",      sub: "Coordinate with your travel group",     nav: "stack", target: "Groups"      },
  { key: "connections", Icon: ShareNetwork, label: "Connections", sub: "People on the journey with you",        nav: "stack", target: "Connections" },
  { key: "contacts",    Icon: AddressBook,  label: "My Contacts", sub: "Hotel, guide, agent and key numbers",   nav: "stack", target: "MyContacts"  },
  { key: "moments",     Icon: ImageSquare,  label: "Moments",     sub: "Share beautiful postcards and prayers",  nav: "stack", target: "Moments"     },
...
export default function ConnectMainScreen({ navigation }) {
    ...
    <View style={styles.root}>
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSub}>{"Stay close to your group and share the journey with those you love."}</Text>
        </View>
      </View>
      ...
      >
        ...
        <View style={{ marginHorizontal: 16 }}>
          <SafarAssistCard
            ...
            subtitle="Import your group details and travel contacts"
