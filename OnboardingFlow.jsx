...
const ns = StyleSheet.create({
  ...
  footer:     { paddingBottom: 44, paddingTop: 20 },
  btn:        {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10,
...
function JourneyTypeScreen({ userName, onNext, onBack }) {
  ...
  return (
    <SafeAreaView style={jts.root}>
      ...
      {/* Footer: stepper dots + back/continue navigation */}
      <View style={jts.footer}>
        <View style={jts.dotsRow}>
          <ProgressDots total={6} active={2} />
        </View>
        <View style={jts.navRow}>
          <TouchableOpacity style={jts.backBtn} onPress={onBack} activeOpacity={0.8}>
            <ArrowRight size={18} color={T.sub} weight="bold" style={{ transform: [{ scaleX: -1 }] }} />
            <Text style={jts.backTxt}>Back</Text>
          </TouchableOpacity>
          <TouchableOpacity
...
const jts = StyleSheet.create({
  ...
  title:        { fontFamily: SERIF, fontSize: 32, color: T.text, lineHeight: 40, marginBottom: 10 },
  ...
  cardLabel:    { fontFamily: SERIF, fontSize: 23, color: T.text, fontWeight: "600", marginBottom: 4 },
  cardDesc:     { fontSize: 17, color: "#3A3630", fontWeight: "500", paddingRight: 34 },

  cardLabelSelected:  { color: "#FFFFFF" },
  cardDescSelected:   { color: "rgba(255,255,255,0.92)" },
  ...
  backTxt:      { fontFamily: SERIF, fontSize: 16, color: T.sub, fontWeight: "500" },
  btn:          {
    flex: 1,
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10,
