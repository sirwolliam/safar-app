...
const CONTENT_TILES = [
  { id:"duas",   label:"Duas",           sub:"Browse, save and practise", screen:"Duas",         image:require("../assets/duas2.png") },
  { id:"expect", label:"What to Expect", sub:"Worship, health & travel tips", screen:"WhatToExpect", image:require("../assets/prepare2.png") },
];
...
const s = StyleSheet.create({
  ...
  tileLabel:{ fontFamily:SERIF, fontSize:15, fontWeight:"400", color:colors.text, lineHeight:20, marginBottom:3, textAlign:"center" },
  tileSub:  { fontSize:13, color:"#6A5E50", fontWeight:"400", lineHeight:17, textAlign:"center" },
