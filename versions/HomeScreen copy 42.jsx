...
const HERO_SLIDES = [
  ...
  {
    id: "people",
    image: require("../assets/06_mina_cinematic.jpg"),
...
export default function HomeScreen({ navigation }) {
  ...
  const renderSlide = ({ item: slide }) => (
    ...
    >
      ...
      {/* Top right — days to go: big number left, "days / to go" stacked right */}
      {daysAway !== null ? (
        ...
        {introDismissed ? (
          ...
          <View style={s.introCard}>
            ...
            <Text style={s.introBody}>
              {"Step-by-step Hajj & Umrah guidance, du\u02bf\u0101\u02bes for every moment, and tools to keep your group connected \u2014 built to be used on the ground."}
            </Text>
...
const s = StyleSheet.create({
  ...
  // Tag — plain white uppercase, no pill
  tagText: {
    fontSize: 10,
    color: "rgba(255,255,255,0.75)",
    fontWeight: "700",
