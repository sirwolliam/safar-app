...
const cm = StyleSheet.create({
  ...
  closeBtn:       { fontSize:16, color:"#3D3935", width:50, textAlign:"right" },
  ...
  fieldLabel:     { fontSize:10, fontWeight:"700", letterSpacing:1.5, color:"#3D3935", marginBottom:6 },
  ...
  roleChipText:   { fontSize:14, color:"#3D3935" },
...
const bc = StyleSheet.create({
  ...
  checklistTextDone: { color:"#3D3935", textDecorationLine:"line-through" },
  ...
  duaArabic:         { fontSize:16, color:"#3D3935", textAlign:"right", lineHeight:28, marginBottom:4 },
...
const pl = StyleSheet.create({
  ...
  translitText:    { fontSize:14, color:"#3D3935", fontStyle:"italic", lineHeight:14*1.7, fontWeight:"400", paddingVertical:8 },
  transText:       { fontFamily:SERIF, fontSize:16, color:"#1A1712", lineHeight:16*1.65, fontWeight:"400", paddingVertical:8 },
  sourceText:      { fontSize:12, color:"#3D3935", marginTop:8, opacity:0.7 },
  ...
  ctrlIcon:        { fontSize:22, color:"#3D3935" },
  ctrlIconDisabled:{ color:"#D4D0CA" },
  ctrlLabel:       { fontSize:12, color:"#3D3935", fontWeight:"400" },
...
const sr = StyleSheet.create({
  ...
  numText:       { fontSize:14, color:"#3D3935", fontWeight:"500" },
  ...
  nameDone:      { color:"#3D3935" },
  sub:           { fontSize:14, color:"#3D3935", fontWeight:"400" },
...
const sd = StyleSheet.create({
  ...
  line:    { height:1, backgroundColor:"#D4D0CA", marginBottom:14 },
  textWrap:{ },
  label:   { fontFamily:"SourceSerif4-Regular", fontSize:17, color:"#1A1712", fontWeight:"400" },
  sub:     { fontSize:12, color:"#6B6259", fontWeight:"500", marginTop:2, lineHeight:17 },
});
...
const jn = StyleSheet.create({
  ...
  pageTitle:     { fontFamily:SERIF, fontSize:28, fontWeight:"400", color:"#1A1712", flex:1, marginBottom:3 },
  pageSub:       { fontSize:14, color:"#3D3935", lineHeight:20, fontWeight:"500", maxWidth:"68%", marginTop:0 },
  ...
  departureLbl:  { fontSize:9, color:"#3D3935", textAlign:"center", letterSpacing:0.3 },
  ...
  modeName:       { fontFamily:SERIF, fontSize:19, color:"#3D3935", fontWeight:"400", letterSpacing:1 },
  modeNameActive: { color:"#fff", fontWeight:"600" },
  modeSub:        { fontSize:13, color:"#3D3935", fontWeight:"400", textAlign:"center" },
  modeSubActive:  { color:"rgba(255,255,255,0.8)" },

  // ── Entries card (below calendar card) ──────────────────────────────────────
  entriesCard:         { backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#D4D0CA", marginBottom:12, shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.08, shadowRadius:6, elevation:2, maxHeight:280 },
  entriesCardHeader:   { paddingHorizontal:16, paddingTop:14, paddingBottom:10, borderBottomWidth:1, borderBottomColor:"#F0EBE2" },
  entriesCardTitle:    { fontFamily:SERIF, fontSize:16, color:"#1A1712", marginBottom:2 },
  entriesCardSub:      { fontSize:12, color:"#6B6259" },
  entriesCardScroll:   { paddingHorizontal:16 },

  // ── Dates card ──────────────────────────────────────────────────────────────
  datesCardWrap:      { backgroundColor:"#FDFAF4", borderRadius:16, borderWidth:1, borderColor:"#D4D0CA", marginBottom:12, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.12, shadowRadius:8, elevation:4, overflow:"hidden" },
  datesCardMain:      { flexDirection:"row", alignItems:"center", padding:18, gap:12 },
  datesCardChevStrip: { flexDirection:"row", alignItems:"center", justifyContent:"center", gap:8, paddingVertical:9, borderTopWidth:1, borderTopColor:"#D4D0CA", backgroundColor:"#F8F5EF" },
  datesCardChevTxt:   { fontSize:11, color:"#3D3935", fontWeight:"600" },
  datesCardChevLabel: { fontSize:12, color:"#4A4540" },
  datesEntriesBody:   { borderTopWidth:1, borderTopColor:"#D4D0CA", paddingHorizontal:16 },
  datesEntriesExplainer: { paddingHorizontal:16, paddingVertical:10, backgroundColor:"#F5F2EC", marginHorizontal:-16, marginBottom:8 },
  datesEntriesExplainerTxt: { fontSize:12, color:"#4A4540" },
  ...
  datesCardEyebrow: { fontSize:9, fontWeight:"700", letterSpacing:2, color:"#6B6259", marginBottom:4, textTransform:"uppercase" },
  datesCardTitle:   { fontFamily:SERIF, fontSize:20, color:"#1A1712", marginBottom:4 },
  datesCardSub:     { fontSize:13, color:"#3D3935", lineHeight:18 },
  ...
  datesCardMonthYr: { fontFamily:SERIF, fontSize:13, color:"#3D3935", textAlign:"center", lineHeight:17 },
  datesCardDays:    { fontSize:11, color:"#6B6259", textAlign:"center", marginTop:2 },

  // ── Calendar sheet ───────────────────────────────────────────────────────────
  calOverlay:      { flex:1, backgroundColor:"rgba(0,0,0,0.45)", justifyContent:"flex-end" },
  calSheet:        { backgroundColor:"#FDFAF4", borderTopLeftRadius:24, borderTopRightRadius:24, maxHeight:"88%", minHeight:480, paddingHorizontal:20, paddingBottom:24 },
  calHandle:       { width:36, height:4, borderRadius:2, backgroundColor:"#D4D0CA", alignSelf:"center", marginTop:12, marginBottom:8 },
  ...
  calSub:          { fontSize:13, color:"#3D3935", marginTop:2 },
  ...
  calLegend:       { flexDirection:"row", gap:16, paddingBottom:10, borderBottomWidth:1, borderBottomColor:"#E8E0D0", marginBottom:8, flexWrap:"wrap" },
  calLegendItem:   { flexDirection:"row", alignItems:"center", gap:6 },
  calLegendDot:    { width:8, height:8, borderRadius:4 },
  calLegendTxt:    { fontSize:12, color:"#3D3935" },
  ...
  calNote:              { backgroundColor:"#F5EDD8", borderRadius:10, borderWidth:1, borderColor:"#E8D9B8", padding:12, marginTop:12 },
  ...
  calEntriesEmpty:      { fontSize:14, color:"#6B6259", textAlign:"center", paddingVertical:20, fontStyle:"italic" },
  calEntryInputWrap:    { backgroundColor:"#EBF2EE", borderRadius:12, marginTop:10, padding:12 },
  ...
  // ── Checklist dropdown ───────────────────────────────────────────────────────
  checklistHeader:        { borderRadius:16, overflow:"hidden", marginBottom:12, height:96, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  ...
  checkTxtDone:           { color:"#3D3935", textDecorationLine:"line-through" },
  ...
  compactSub:          { fontSize:14, color:"#3D3935", lineHeight:18 },
  ...
  linkSub:             { fontSize:13, color:"#3D3935", fontWeight:"400" },
  ...
  linkCounterOf:       { fontSize:10, color:"#3D3935", textAlign:"center" },
  ...
  headerSub:           { fontSize:14, color:"#3D3935", fontWeight:"400", marginTop:2 },
  ...
  departureLbl:        { fontSize:10, color:"#3D3935", textAlign:"center", lineHeight:13, letterSpacing:0.3 },
