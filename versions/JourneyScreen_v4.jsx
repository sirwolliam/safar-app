      ...
      <ImageBackground source={source} style={wc.bg} imageStyle={wc.bgImg}>
        ...
        <View style={wc.content}>
          ...
          <View style={wc.topRow}>
            ...
            <View style={{ flex:1 }} />
            <View style={wc.arrowCircle}>
              <Text style={wc.arrow}>{"›"}</Text>
            </View>
          </View>
          {/* Bottom text — serif titles */}
          <View>
...
const wc = StyleSheet.create({
  ...
  scrimGrad:  { position:"absolute", bottom:0, left:0, right:0, height:"72%", backgroundColor:"rgba(6,14,8,0.70)" },
  ...
  arrowCircle:{ width:32, height:32, borderRadius:16, backgroundColor:"rgba(255,255,255,0.14)",
                borderWidth:1, borderColor:"rgba(255,255,255,0.22)", alignItems:"center", justifyContent:"center" },
  arrow:      { fontSize:20, color:"#fff", lineHeight:24 },
...
const dc = StyleSheet.create({
  ...
  dayNum:  { fontFamily:SERIF, fontSize:52, color:V.green, lineHeight:56 },
  monthYr: { fontSize:12, color:V.textSub, fontWeight:"600", textAlign:"center", marginTop:2 },
