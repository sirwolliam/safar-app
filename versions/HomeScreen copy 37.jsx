    ...
    <SafeAreaView style={s.safe}>
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.scrollHint} pointerEvents="none">
          ...
          <View style={s.scrollHintArrow}>
            <Text style={s.scrollHintTxt}>{"∨"}</Text>
          </View>
        </View>
        ...
        <View style={s.content}>
          ...
          <View style={s.journeyGrid}>
            {[
              { img:require("../assets/kaaba_mixed.png"),     label:"Guide",         sub:"Step-by-step rites",            screen:"Journey", scrim:"rgba(10,20,12,0.30)" },
              { img:require("../assets/kaaba_map.png"),       label:"Sacred Places", sub:"Sites & du\u02bf\u0101s",       screen:"Map" },
              { img:require("../assets/checklist_kaaba.jpg"), label:"Checklist",     sub:checkDone+"/"+checkTotal+" done",screen:"Journey", badge:checkPct < 100 ? checkTotal-checkDone : null, scrim:"rgba(20,10,5,0.28)" },
              { img:require("../assets/journey3.png"),        label:"My Calendar",   sub:"Dates & notes",                 screen:"Journey", scrim:"rgba(6,20,14,0.32)" },
            ].map((item, i) => (
              <TouchableOpacity key={i} style={s.journeyTile}
                ...
                <ImageBackground source={item.img} style={StyleSheet.absoluteFill}
                  imageStyle={{ resizeMode:"cover" }}>
                  <View style={[s.journeyTileScrim, { backgroundColor: item.scrim }]} />
                </ImageBackground>
                {item.badge ? (
          ...
          <View style={s.peopleRow}>
            {[
              { img:require("../assets/contacts2.png"),  eyebrow:"CONTACTS",  title:"My Contacts", sub:contactCount > 0 ? contactCount+" saved" : "Hotel, guide & more", screen:"MyContacts", scrim:0.42 },
              { img:require("../assets/myboard.jpg"),    eyebrow:"COMMUNITY", title:"My Groups",   sub:"Share milestones",                                                screen:"Groups",     scrim:0.35 },
            ].map((item, i) => (
              <TouchableOpacity key={i} style={s.peopleCard}
                onPress={() => navigation?.navigate?.(item.screen)} activeOpacity={0.88}>
                <ImageBackground source={item.img} style={StyleSheet.absoluteFill}
                  imageStyle={{ resizeMode:"cover" }}>
                  <View style={[s.peopleScrim, { backgroundColor:`rgba(6,14,8,${item.scrim * 0.75})` }]} />
                </ImageBackground>
...
const s = StyleSheet.create({
  ...
  // Card label
  cardLabel:      { paddingHorizontal:20, paddingVertical:10 },
  cardLabelTxt:   { fontSize:13, color:"#5C534A", fontWeight:"500", textAlign:"center" },
  ...
  departureDaysWrap:{ flex:1, padding:13, alignItems:"center", justifyContent:"center" },
  ...
  departureProgress:{ flex:1, padding:13, justifyContent:"center" },
  ...
  scrollHintLine:  { width:1, height:10, backgroundColor:"#C8BFB2", marginBottom:3 },
  scrollHintArrow: { width:24, height:24, borderRadius:12, borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center" },
  scrollHintTxt:   { fontSize:11, color:"#8A7D70", fontWeight:"600", lineHeight:13 },
  ...
  journeyTileScrim:{ ...StyleSheet.absoluteFillObject },
  ...
  toolScrim:      { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(6,12,8,0.38)" },
