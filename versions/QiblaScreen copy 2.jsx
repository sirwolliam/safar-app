    ...
    <Svg width={SIZE} height={SIZE} viewBox={`0 0 ${SIZE} ${SIZE}`}>
      ...
      {(() => {
        ...
        return (
          <G>
            {/* Outer glow ring */}
            <Circle cx={ix} cy={iy} r={14} fill="rgba(47,93,80,0.15)" />
            {/* Green circle background */}
            <Circle cx={ix} cy={iy} r={11} fill="#2F5D50" stroke="#FDFAF4" strokeWidth={2} />
            {/* Cube body — simplified Ka'bah shape */}
            <Path
              d={`M ${ix-4} ${iy-4} L ${ix+4} ${iy-4} L ${ix+4} ${iy+4} L ${ix-4} ${iy+4} Z`}
              fill="#1A1712"
            />
            {/* Gold band on cube */}
            <Path
              d={`M ${ix-4} ${iy-1} L ${ix+4} ${iy-1} L ${ix+4} ${iy+1} L ${ix-4} ${iy+1} Z`}
              fill="#C8A96A"
            />
          </G>
        );
      ...
      {/* Centre dot */}
      <Circle cx={CX} cy={CY} r={5} fill="#2F5D50" />
