  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── 4. Import My Journey — AI-powered setup card ── */}
        <TouchableOpacity
          style={jn.importCard}
          onPress={() => navigation?.navigate?.("Journey")}
          activeOpacity={0.88}
        >
          <View style={jn.importLeft}>
            <Text style={jn.importEyebrow}>AI-POWERED</Text>
            <Text style={jn.importTitle}>Set Up My Journey</Text>
            <Text style={jn.importSub}>Add your itinerary, key dates and contacts in seconds</Text>
          </View>
          <Text style={jn.importArrow}>{"›"}</Text>
        </TouchableOpacity>

        {/* ── 5. Sacred Places + What to Expect — real images ── */}
        ...
        {/* ── 6. Groups + Contacts — compact utility row ── */}
...
const jn = StyleSheet.create({
  ...
  importCard: {
    ...
    borderRadius:14, marginHorizontal:spacing(2.5),
    marginBottom:spacing(1.5), padding:spacing(2),
    shadowColor:"#4A2E10", shadowOffset:{width:0,height:3},
    shadowOpacity:0.18, shadowRadius:8, elevation:4,
  },
  importLeft:    { flex:1 },
  importEyebrow: { fontSize:9, color:"#C8A96A", fontWeight:"700", textTransform:"uppercase", marginBottom:4 },
  importTitle:   { fontFamily:SERIF, fontSize:17, color:"#FDFAF4", fontWeight:"600", marginBottom:4 },
  importSub:     { fontSize:13, color:"rgba(253,250,244,0.65)", lineHeight:18 },
  importArrow:   { fontSize:28, color:"#C8A96A", paddingLeft:12 },
});
