      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <TouchableOpacity style={jn.boardCard}
          ...
          <ImageBackground
            ...
            imageStyle={{ resizeMode:"cover" }}>
            {/* Gradient scrim — dark left, fades right */}
            <View style={jn.boardScrim} />
            {/* Text stacked left — no solid bar */}
        ...
        <View style={jn.compactRow}>
          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            activeOpacity={0.88}>
            <View style={jn.compactAccent} />
            <View style={{ flex:1 }}>
              <Text style={jn.compactTitle}>My Groups</Text>
              <Text style={jn.compactSub}>Share milestones with your pilgrimage family</Text>
            </View>
...
const jn = StyleSheet.create({
  ...
  modeOpt:         { flex:1, alignItems:"center", paddingVertical:spacing(2.5), borderRadius:radius.lg, gap:6, backgroundColor:colors.card, borderWidth:1.5, borderColor:colors.border, ...shadows.card },
  modeOptActive:   { borderColor:colors.primary, backgroundColor:colors.primary },
  modeEmoji:       { fontSize:28 },
  modeName:        { fontFamily:SERIF, fontSize:17, color:colors.subtext },
  modeNameActive:  { color:"#fff", fontWeight:"500" },
  modeSub:         { fontSize:12, color:colors.subtext, fontWeight:"400", textAlign:"center", paddingHorizontal:spacing(1) },
  ...
  // Board card — real image, text left-stacked, no solid bar
  boardCard:      { borderRadius:radius.xl, overflow:"hidden", marginBottom:spacing(1.5), height:180, ...shadows.card },
  boardCardBg:    { flex:1 },
  boardScrim:     { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(10,8,4,0.42)" },
  boardContent:   { position:"absolute", top:0, bottom:0, left:0, right:0, justifyContent:"flex-end", padding:spacing(2.5) },
  boardTitle:     { fontFamily:SERIF, fontSize:22, color:"#fff", fontWeight:"400", marginBottom:4 },
  boardSub:       { fontSize:13, color:"rgba(255,255,255,0.72)", marginBottom:spacing(1.5) },
  boardStats:     { flexDirection:"row", gap:spacing(3) },
  boardStat:      { alignItems:"flex-start" },
  boardStatNum:   { fontFamily:SERIF, fontSize:32, color:"#fff", fontWeight:"400", lineHeight:36 },
  boardStatLbl:   { fontSize:11, color:"rgba(255,255,255,0.65)", letterSpacing:0.5 },
  boardEmpty:     { fontSize:14, color:"rgba(255,255,255,0.75)", fontStyle:"italic" },
  ...
  compactCard:     { flex:1, flexDirection:"row", alignItems:"center", gap:spacing(1.5), backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, paddingVertical:spacing(2), paddingRight:spacing(1.75), overflow:"hidden", ...shadows.card },
  compactAccent:   { width:4, alignSelf:"stretch", backgroundColor:colors.primary, borderRadius:2, flexShrink:0 },
  compactTitle:    { fontFamily:SERIF, fontSize:15, color:colors.text, marginBottom:3 },
  compactSub:      { fontSize:12, color:colors.subtext, lineHeight:16 },
  compactArrow:    { fontSize:18, color:colors.border, flexShrink:0 },
