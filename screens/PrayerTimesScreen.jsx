...
const s = StyleSheet.create({
  ...
  refreshBtn:   { width:36, height:36, borderRadius:18, backgroundColor:"#F5EDE0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center" },
  refreshIcon:  { fontSize:20, color:"#1E3D30" },

  // Location bar
  locationBar:    { flexDirection:"row", alignItems:"center", backgroundColor:"#F5EDE0", borderRadius:14, borderWidth:1, borderColor:"#C8BFB2", paddingHorizontal:18, paddingVertical:12, marginBottom:8, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:6, elevation:3 },
