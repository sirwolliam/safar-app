        ...
        <View style={s.content}>
          ...
          <View style={s.explainerWrap}>
            <Text style={s.explainerText}>
              {"Use this page to stay on track before and during your journey. Check your countdown, practise a duʿā, and access everything you need in one place."}
            </Text>
          </View>
...
const s = StyleSheet.create({
  ...
  // ── Content ───────────────────────────────────────────────────────────────
  content: { paddingTop:72, paddingHorizontal:20 },

  sectionHeader:  { marginBottom:12, marginTop:24 },
  explainerWrap:   { marginBottom:4 },
  explainerText:   { fontSize:14, color:"#5C534A", fontWeight:"500", lineHeight:21 },
