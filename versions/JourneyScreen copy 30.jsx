      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <TouchableOpacity style={jn.wideCard}
          ...
          <ImageBackground
            ...
            <View style={jn.wideCardContent}>
              <View style={jn.wideCardTopRow}>
                <View style={jn.boardCardDeparture}>
                  <Text style={jn.boardCardDepartureDays}>{daysUntil}</Text>
                  <Text style={jn.boardCardDepartureLbl}>days to go</Text>
                </View>
                <Text style={jn.wideCardArrow}>{"›"}</Text>
              </View>
              <View>
...
const jn = StyleSheet.create({
  ...
  pageTitle:   { fontFamily:SERIF, fontSize:32, fontWeight:"400", color:"#1A1712", marginBottom:6, lineHeight:38 },
