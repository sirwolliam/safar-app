...
const TAB_ITEMS = [
  { key:"myLists", label:"My Dua Lists",  sub:"Your saved lists", img:require("../assets/tab_my_lists.jpg")     },
  { key:"library", label:"Dua Library",   sub:"Browse all duas",  img:require("../assets/tab_dua_library.jpg")  },
