...
const cc = StyleSheet.create({
  ...
  phonePlaceholder: { fontSize:13, color:"#7A7670", fontStyle:"italic" },
  ...
  expandInfo:   { flex:1 },
  expandLabel:  { fontSize:11, color:"#7A7670", fontWeight:"500", marginBottom:1 },
  expandValue:  { fontSize:15, fontWeight:"400" },
  expandNote:   { fontSize:14, color:"#5A5650", lineHeight:20 },
  expandArrow:  { fontSize:18, color:"#D4D0CA" },
  noDetails:    { fontSize:13, color:"#7A7670", fontStyle:"italic", paddingVertical:10, textAlign:"center" },
...
const s = StyleSheet.create({
  ...
  searchClear:  { fontSize:14, color:"#9A8E7A" },
  ...
  importChev:     { fontSize:11, color:"#5A5650" },
  ...
  sectionLabelTxt: { fontSize:11, fontWeight:"700", letterSpacing:1.5, color:"#8A7A60", textTransform:"uppercase" },

  empty:       { flex:1, alignItems:"center", justifyContent:"center", padding:32 },
  emptyEmoji:  { fontSize:44, marginBottom:16 },
  emptyTitle:  { fontFamily:SERIF, fontSize:20, color:"#1A1712", marginBottom:8 },
  emptyBody:   { fontSize:16, color:"#5A5650", textAlign:"center", lineHeight:22, marginBottom:20 },
