  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── SCHOLARLY FOOTNOTE ── */}
        <View style={jn.footnoteWrap}>
          <Text style={jn.footnoteText}>
            <Text style={jn.footnoteBold}>Sources</Text>
...
const jn = StyleSheet.create({
  ...
  // ── Scholarly footnote ──────────────────────────────────────────────────────
  footnoteWrap: { marginBottom:spacing(1), backgroundColor:"#F5EDD8", borderRadius:12, borderWidth:1, borderColor:"#E8D9B8", padding:14 },
