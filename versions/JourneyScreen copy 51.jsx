...
export default function JourneyScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      {/* ── Calendar modal — calendar only, tap date to add entry ── */}
              ...
              <TouchableOpacity activeOpacity={1} onPress={() => {}} style={{ flex:1 }}>
                ...
                <View style={jn.calLegend}>
                  <View style={jn.calLegendItem}>
                    ...
                    <Text style={jn.calLegendTxt}>Your departure</Text>
                  </View>
                  <View style={jn.calLegendItem}>
                ...
                {/* Entry input — appears when a date is tapped */}
                {addingEntry && (
                ...
                <View style={jn.calNote}>
                  <Text style={jn.calNoteTxt}>
                    {"Gold dots mark estimated Hajj 1446 AH dates. Verify with your local authority or Hajj operator."}
                  </Text>
                </View>
...
const jn = StyleSheet.create({
  ...
  // ── Dates card ──────────────────────────────────────────────────────────────
  datesCardWrap:      { backgroundColor:"#EAF0EC", borderRadius:16, borderWidth:1, borderColor:"#B8D4C0", marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.12, shadowRadius:8, elevation:4, overflow:"hidden" },
  ...
  // ── Calendar sheet ───────────────────────────────────────────────────────────
  calOverlay:      { flex:1, backgroundColor:"rgba(0,0,0,0.50)", justifyContent:"center", alignItems:"center", paddingHorizontal:16 },
  calSheet:        { backgroundColor:"#F5EDE0", borderRadius:24, width:"100%", maxHeight:"82%", paddingHorizontal:24, paddingBottom:24 },
  calHandle:       { width:36, height:4, borderRadius:2, backgroundColor:"#C8BFB2", alignSelf:"center", marginTop:12, marginBottom:8, display:"none" },
