...
const CARD_OVERLAP = 94; // 69 + 25 = card moves up another 25px
...
const s = StyleSheet.create({
  ...
  // Scrollable text content — 15px extra horizontal padding on each side
  contentScroll: { flex:1 },
  contentPad:    { paddingHorizontal:spacing(3) + 15, paddingTop:spacing(3), paddingBottom:spacing(2) },
  ...
  // Speed circle — centered between the two toggles
  speedCircle: {
    width:30,
    height:30,
    borderRadius:15,
  ...
  // Single row: label · toggle · [speed circle] · label · toggle
  togglesRow: {
    flexDirection:"row",
    alignItems:"center",
    justifyContent:"space-between",
