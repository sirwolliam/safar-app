...
const rg = StyleSheet.create({
  ...
  roundNum:   { fontSize:80, color:WHITE, fontWeight:"200", lineHeight:84, letterSpacing:-3 },
...
const s = StyleSheet.create({
  ...
  completeBtn: {
    alignSelf:"center", width:RING_SIZE, backgroundColor:GREEN_DARK, borderRadius:18,
  ...
  doneBtn: {
    alignSelf:"center", width:RING_SIZE, backgroundColor:"#2A5C30", borderRadius:18,
  ...
  dotsCard: {
    ...
    paddingVertical:18, paddingHorizontal:16, alignItems:"center", marginBottom:spacing(2),
  },
