...
const row = StyleSheet.create({
  ...
  sub:        { fontSize:12, color:colors.subtext, fontWeight:"300" },
...
const s = StyleSheet.create({
  ...
  card:        { marginHorizontal:spacing(2.5), backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, overflow:"hidden", marginBottom:spacing(1) },
