          ...
          <View style={ml.sheet}>
            <View style={ml.sheetHeader}>
              ...
              <TouchableOpacity onPress={handleSave} disabled={!url.trim()}>
                <Text style={[ml.save, !url.trim() && ml.saveDisabled]}>Save</Text>
              </TouchableOpacity>
            </View>
...
const ml = StyleSheet.create({
  ...
  tipText:     { flex:1, fontSize:typography.tiny, color:colors.primary, lineHeight:17 },
  fieldLabel:  { fontSize:10, fontWeight:"700", letterSpacing:1.5, color:colors.subtext, marginBottom:spacing(0.75) },
  input:       { backgroundColor:colors.background, borderRadius:radius.md, borderWidth:1, borderColor:colors.border, paddingHorizontal:spacing(1.75), paddingVertical:spacing(1.25), fontSize:typography.body, color:colors.text, marginBottom:spacing(2) },
                ...
                <View style={s.card}>
                  {duas.map((dua, i) => (
                    <TouchableOpacity key={dua.id}
                      style={[s.duaRow, i < duas.length - 1 && s.duaRowBorder]}
        ...
        <>
          ...
          {links.length === 0 ? (
            ...
            <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
              <View style={s.card}>
                {links.map((link, i) => (
                  <View key={link.id} style={[s.linkRow, i < links.length - 1 && s.linkRowBorder]}>
...
const createStyles = (colors) => StyleSheet.create({
  ...
  duaArabic:    { fontSize:typography.small, color:colors.subtext, textAlign:"right" },
