...
const cf = StyleSheet.create({
  card:        { borderRadius:16, borderWidth:1, padding:14, shadowColor:"#1A1712", shadowOffset:{width:0,height:2}, shadowOpacity:0.06, shadowRadius:8, elevation:3, marginBottom:10 },
  headerRow:   { flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginBottom:10 },
  iconTitleRow:{ flexDirection:"row", alignItems:"flex-start", gap:10, marginBottom:8 },
  cardTitle:   { fontFamily:SERIF, fontSize:15, color:"#1A1712", flex:1, lineHeight:20 },
  cardBody:    { fontSize:12, color:"#5A5650", lineHeight:18, marginBottom:4 },
  cardSub:     { fontSize:11, color:"#8A8070", marginTop:4 },
  ...
  checkOn:     { width:16, height:16, borderRadius:8, backgroundColor:"#2F5D50", alignItems:"center", justifyContent:"center", flexShrink:0 },
  checkMark:   { fontSize:9, color:"#fff", fontWeight:"700" },
  checkTxt:    { flex:1, fontSize:12, color:"#1A1712", lineHeight:17 },
  checkDone:   { color:"#9A9080", textDecorationLine:"line-through" },
  moreItems:   { fontSize:10, color:"#8A8070", marginTop:2 },
  progRow:     { flexDirection:"row", alignItems:"center", gap:6, marginTop:6 },
  progTrack:   { flex:1, height:2.5, backgroundColor:"#D4D0CA", borderRadius:2, overflow:"hidden" },
  progFill:    { height:"100%", backgroundColor:"#2F5D50", borderRadius:2 },
  progTxt:     { fontSize:10, color:"#8A8070" },
  arabic:      { fontSize:15, color:"#1A1712", textAlign:"right", lineHeight:26, marginBottom:4 },
  linkUrl:     { fontSize:11, color:"#2F5D50", marginTop:2, marginBottom:4 },
});
    ...
    <View style={hb.wrap}>
      ...
      >
        ...
        <View style={hb.content}>
          <Text style={hb.quote}>{"Prepare with\nintention. Travel\nwith purpose."}</Text>
          <Text style={hb.sub}>{"Organise what matters most for\nyour Hajj & Umrah journey."}</Text>
        </View>
      </ImageBackground>
    </View>
  );
...
const hb = StyleSheet.create({
  wrap:    { marginHorizontal:20, borderRadius:20, overflow:"hidden", height:190, marginBottom:14, shadowColor:"#1A1712", shadowOffset:{width:0,height:4}, shadowOpacity:0.12, shadowRadius:12, elevation:5 },
  bg:      { flex:1 },
  bgImg:   { resizeMode:"cover" },
  scrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(240,230,210,0.55)" },
  content: { flex:1, justifyContent:"center", paddingHorizontal:22, paddingVertical:20 },
  quote:   { fontFamily:SERIF, fontSize:26, color:"#1A1712", lineHeight:33, marginBottom:10, maxWidth:"62%" },
  sub:     { fontSize:13, color:"#4A4030", lineHeight:19, maxWidth:"62%" },
});
...
const ab = StyleSheet.create({
  wrap:      { backgroundColor:"#2F5D50", marginHorizontal:20, borderRadius:18, padding:16, marginBottom:14, shadowColor:"#1A3A2A", shadowOffset:{width:0,height:4}, shadowOpacity:0.2, shadowRadius:12, elevation:6 },
...
const tp2 = StyleSheet.create({
  wrap:      { backgroundColor:"#FDFAF4", borderRadius:18, borderWidth:1, borderColor:"#E8E0D0", marginHorizontal:20, marginBottom:14, paddingTop:16, shadowColor:"#1A1712", shadowOffset:{width:0,height:2}, shadowOpacity:0.06, shadowRadius:8, elevation:2 },
  ...
  title:     { fontFamily:SERIF, fontSize:16, color:"#1A1712", marginBottom:1 },
  sub:       { fontSize:12, color:"#7A7060" },
  manage:    { fontSize:13, color:"#2F5D50", fontWeight:"500" },
  empty:     { fontSize:13, color:"#9A9080", textAlign:"center", paddingHorizontal:16, paddingBottom:16, paddingTop:8, fontStyle:"italic" },
  ...
  xTxt:      { fontSize:16, color:"#9A9080" },
  pinIconRow:{ flexDirection:"row", alignItems:"center", gap:8, marginTop:8 },
  pinTitle:  { fontFamily:SERIF, fontSize:13, color:"#1A1712", flex:1, lineHeight:18 },
});
...
const qa = StyleSheet.create({
  ...
  sheetTitle:   { fontFamily:SERIF, fontSize:17, color:"#1A1712" },
  cancel:       { fontSize:15, color:"#5A5650", width:60 },
  save:         { fontSize:15, color:"#2F5D50", fontWeight:"600", width:60, textAlign:"right" },
  typeRow:      { flexDirection:"row", gap:8, marginBottom:14 },
  typeBtn:      { flex:1, alignItems:"center", paddingVertical:10, borderRadius:12, borderWidth:1.5, borderColor:"#D4D0CA", backgroundColor:"#FDFAF4", gap:4 },
  typeEmoji:    { fontSize:20 },
  typeLabel:    { fontSize:11, color:"#5A5650" },
  input:        { backgroundColor:"#FDFAF4", borderRadius:12, borderWidth:1, borderColor:"#D4D0CA", paddingHorizontal:14, paddingVertical:12, fontSize:16, color:"#1A1712", marginBottom:10, shadowColor:"#1A1712", shadowOffset:{width:0,height:1}, shadowOpacity:0.06, shadowRadius:4, elevation:1 },
  inputTall:    { minHeight:96, textAlignVertical:"top" },
  inputArabic:  { minHeight:80, textAlignVertical:"top", fontSize:18, lineHeight:30 },
  checklistWrap:{ backgroundColor:"#FDFAF4", borderRadius:12, borderWidth:1, borderColor:"#D4D0CA", padding:12, marginBottom:10 },
  ...
  removeItem:   { fontSize:18, color:"#9A8E7A", lineHeight:22 },
  addItemBtn:   { paddingVertical:6 },
  addItemTxt:   { fontSize:14, color:"#2F5D50", fontWeight:"500" },
  pinRow:       { flexDirection:"row", alignItems:"center", justifyContent:"space-between", backgroundColor:"#FDFAF4", borderRadius:12, borderWidth:1, borderColor:"#D4D0CA", padding:14, marginBottom:8 },
  pinTxt:       { fontFamily:SERIF, fontSize:15, color:"#1A1712" },
  ...
  knob:         { width:20, height:20, borderRadius:10, backgroundColor:"#fff", shadowColor:"#1A1712", shadowOffset:{width:0,height:1}, shadowOpacity:0.15, shadowRadius:2, elevation:1 },
...
const es = StyleSheet.create({
  ...
  quoteCard: { backgroundColor:"#FDFAF4", borderRadius:20, borderWidth:1, borderColor:"#E8E0D0", padding:22, marginBottom:20, width:"100%", alignItems:"center", shadowColor:"#1A1712", shadowOffset:{width:0,height:2}, shadowOpacity:0.06, shadowRadius:8, elevation:2 },
  arabic:    { fontSize:22, color:"#1A1712", textAlign:"center", lineHeight:38, marginBottom:12 },
  quote:     { fontFamily:SERIF, fontSize:15, color:"#1A1712", textAlign:"center", fontStyle:"italic", lineHeight:22, marginBottom:6 },
  ref:       { fontSize:11, color:"#8A8070" },
  title:     { fontFamily:SERIF, fontSize:20, color:"#1A1712", marginBottom:8, textAlign:"center" },
  body:      { fontSize:15, color:"#7A7060", textAlign:"center", lineHeight:22 },
});
...
const s = StyleSheet.create({
  ...
  backBtn:      { width:36, height:36, borderRadius:18, backgroundColor:"#fff", borderWidth:1, borderColor:"#E8E0D0", alignItems:"center", justifyContent:"center", shadowColor:"#1A1712", shadowOffset:{width:0,height:1}, shadowOpacity:0.08, shadowRadius:3, elevation:2, marginTop:2 },
  backArrow:    { fontSize:22, color:"#1A1712", lineHeight:26 },
  headerTitle:  { fontFamily:SERIF, fontSize:26, color:"#1A1712", fontWeight:"400", lineHeight:30 },
  headerSub:    { fontSize:13, color:"#8A8070", marginTop:2 },
  headerActions:{ flexDirection:"row", gap:8, marginTop:2 },
  headerBtn:    { width:40, height:40, borderRadius:20, backgroundColor:"#fff", borderWidth:1, borderColor:"#E8E0D0", alignItems:"center", justifyContent:"center", shadowColor:"#1A1712", shadowOffset:{width:0,height:1}, shadowOpacity:0.08, shadowRadius:3, elevation:2 },
  headerBtnTxt: { fontSize:16, color:"#1A1712" },
  ...
  allTitle:  { fontFamily:SERIF, fontSize:22, color:"#1A1712", fontWeight:"400" },
  sortBtn:   { backgroundColor:"#fff", borderRadius:20, borderWidth:1, borderColor:"#E8E0D0", paddingHorizontal:12, paddingVertical:6, shadowColor:"#1A1712", shadowOffset:{width:0,height:1}, shadowOpacity:0.06, shadowRadius:3, elevation:1 },
  sortTxt:   { fontSize:13, color:"#5A5650" },

  // FAB
  fab:      { position:"absolute", bottom:28, right:20, backgroundColor:"#1A3A2A", borderRadius:28, paddingHorizontal:20, paddingVertical:14, flexDirection:"row", alignItems:"center", gap:8, shadowColor:"#1A1712", shadowOffset:{width:0,height:4}, shadowOpacity:0.25, shadowRadius:12, elevation:8 },
