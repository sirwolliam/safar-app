...
import ImportTripScreen    from "./screens/ImportTripScreen";
import PilgrimageMapScreen from "./screens/PilgrimageMapScreen";
...
function HomeNavigator() {
  return (
    <HomeStack.Navigator screenOptions={{ headerShown:false }}>
      ...
      <HomeStack.Screen name="ImportTrip"    component={ImportTripScreen}    />
      <HomeStack.Screen name="PilgrimageMap" component={PilgrimageMapScreen} />
    </HomeStack.Navigator>
  );
}
...
function JourneyNavigator() {
  return (
    <JourneyStack.Navigator screenOptions={{ headerShown:false }}>
      ...
      <JourneyStack.Screen name="ImportTrip"     component={ImportTripScreen}    />
      <JourneyStack.Screen name="PilgrimageMap"  component={PilgrimageMapScreen} />
      <JourneyStack.Screen name="DuaList"        component={DuaListScreen}       />
      <JourneyStack.Screen name="DuaDetail"      component={DuaDetailScreen}     />
...
function PrepareNavigator() {
  return (
    <PrepareStack.Navigator screenOptions={{ headerShown:false }}>
      ...
      <PrepareStack.Screen name="UmrahGuide"    component={UmrahGuideScreen}    />
      <PrepareStack.Screen name="HajjGuide"     component={HajjGuideScreen}     />
      <PrepareStack.Screen name="PilgrimageMap" component={PilgrimageMapScreen} />
