...
const s = StyleSheet.create({
  ...
  // Logomark
  logomark:     { position:"absolute", top:16, left:20, flexDirection:"row", alignItems:"center", gap:8 },
  ...
  heroTagline:       { fontFamily:SERIF, fontSize:16, color:"rgba(255,255,255,0.82)", fontWeight:"400" },
  ...
  explainerWrap:   { marginBottom:4, paddingVertical:12 },
  explainerLine:   { height:1, backgroundColor:"#C8BFB2", marginBottom:10 },
  explainerText:   { fontSize:14, color:"#5C534A", fontWeight:"500", lineHeight:21, textAlign:"center", paddingHorizontal:4 },
  sectionLabel:   { fontFamily:SERIF, fontSize:13, fontWeight:"700", letterSpacing:1.5, color:"#1E3D30" },
