    ...
    <SafeAreaView style={s.safe}>
      ...
      >
        ...
        <View style={s.card}>
          ...
          {/* Source */}
          {activeDua.source ? (
            <Text style={s.source}>Reference: {activeDua.source}</Text>
          ) : null}
...
const s = StyleSheet.create({
  ...
  // Nav
  navRow:  { flexDirection:"row", justifyContent:"space-between", alignItems:"center", paddingHorizontal:20, paddingTop:12 },
  ...
  progressFill:  { height:"100%", backgroundColor:"#2F5D50", borderRadius:2 },
  ...
  ctrlBtn: { alignItems:"center", gap:6, minWidth:64, paddingVertical:4 },
  ...
  // Extra controls row
  extraRow:    { flexDirection:"row", justifyContent:"center", gap:12, marginBottom:16 },
  speedPill:   { paddingHorizontal:16, paddingVertical:6, borderRadius:999, borderWidth:1, borderColor:"#D4D0CA", backgroundColor:"#EDE6D8" },
  speedPillTxt:{ fontSize:13, color:"#1A1712", fontWeight:"500" },
  loopPill:    { paddingHorizontal:16, paddingVertical:6, borderRadius:999, borderWidth:1, borderColor:"#D4D0CA", backgroundColor:"#EDE6D8" },
  loopPillOn:  { backgroundColor:"#2F5D50", borderColor:"#2F5D50" },
  loopPillTxt: { fontSize:13, color:"#1A1712", fontWeight:"400" },
  loopPillTxtOn:{ color:"#fff", fontWeight:"500" },

  // Speed picker
  speedGrid:   { flexDirection:"row", gap:6, marginBottom:14 },
  speedBtn:    { flex:1, paddingVertical:7, borderRadius:6, borderWidth:1, borderColor:"#D4D0CA", backgroundColor:"#EDE6D8", alignItems:"center" },
  speedBtnOn:  { backgroundColor:"#2F5D50", borderColor:"#2F5D50" },
  speedBtnTxt: { fontSize:12, color:"#5A5650" },
  speedBtnTxtOn:{ color:"#fff", fontWeight:"600" },

  // Divider
  divider: { height:1, backgroundColor:"#EDE8E0", marginBottom:16 },

  // Toggles
  toggleRow:   { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingVertical:4, marginBottom:10 },
  ...
  toggleTrackOn:{ backgroundColor:"#2F5D50" },
