...
const ab = StyleSheet.create({
  ...
  body:    { fontSize:16, color:colors.subtext, lineHeight:24, fontWeight:"400", textAlign:"left" },
...
const s = StyleSheet.create({
  ...
  heroTopRow:  {
    ...
    paddingHorizontal:spacing(2.5), paddingTop:spacing(1.5),
  },
  appName:    { fontFamily:SERIF, fontSize:28, fontWeight:"400", color:colors.text, lineHeight:34 },
  appTagline: { fontSize:14, color:colors.primary, fontWeight:"400", marginTop:1 },
  aboutBtn:   {
    borderRadius:radius.md, backgroundColor:"rgba(255,255,255,0.88)",
    borderWidth:1, borderColor:"rgba(47,93,80,0.25)",
    alignItems:"center", justifyContent:"center",
    paddingHorizontal:spacing(1.25), paddingVertical:spacing(0.75),
    marginTop:spacing(0.5),
  },
  aboutBtnTop:    { fontSize:10, color:colors.primary, fontWeight:"600", letterSpacing:0.3, lineHeight:13 },
  aboutBtnMark:   { fontSize:18, color:colors.primary, fontWeight:"700", lineHeight:22 },
  aboutBtnBottom: { fontSize:10, color:colors.primary, fontWeight:"600", letterSpacing:0.3, lineHeight:13 },
  ...
  planTitle:     { fontFamily:SERIF, fontSize:18, fontWeight:"400", color:colors.text, marginBottom:2 },
  ...
  planStepsCount:{ fontFamily:SERIF, fontSize:16, color:colors.primary, fontWeight:"500" },
  ...
  // Tiles
  tilesRow: { flexDirection:"row", gap:spacing(1.25), marginBottom:spacing(2) },
  tile:     { width:TILE_W, borderRadius:radius.md, overflow:"hidden", backgroundColor:colors.card, borderWidth:1, borderColor:colors.border, ...shadows.card },
  tileImg:  { width:"100%", height:78 },
  tileBody: { padding:spacing(1.25), alignItems:"center" },
  tileLabel:{ fontFamily:SERIF, fontSize:18, fontWeight:"400", color:colors.text, lineHeight:23, marginBottom:3, textAlign:"center" },
  tileSub:  { fontSize:16, color:"#6A5E50", fontWeight:"400", lineHeight:20, textAlign:"center" },

  // Connect section
  connectSection: { marginBottom:spacing(1.5) },
  connectLabel:   { fontSize:11, fontWeight:"700", letterSpacing:1.5, color:"#6A5E50", textTransform:"uppercase", textAlign:"center", marginBottom:spacing(1.25) },
  actionRow:  { flexDirection:"row", gap:spacing(1.25) },
  actionCard: { flex:1, flexDirection:"row", alignItems:"center", gap:spacing(1.25), backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, padding:spacing(1.5), ...shadows.card },
  actionIconWrap: { width:40, height:40, borderRadius:radius.md, backgroundColor:"rgba(47,93,80,0.08)", alignItems:"center", justifyContent:"center", flexShrink:0 },
  actionText: { flex:1 },
  actionTitle:{ fontFamily:SERIF, fontSize:14, color:colors.text, marginBottom:2 },
