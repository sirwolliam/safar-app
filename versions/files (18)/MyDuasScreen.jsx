...
const nc = StyleSheet.create({
  ...
  sub:          { fontSize:13, color:"#4A4540", lineHeight:18, marginBottom:10, minHeight:54 },
...
const nl = StyleSheet.create({
  ...
  sub:              { fontSize:13, color:"#3D3935", fontWeight:"400", marginBottom:16 },
  fieldLabel:       { fontSize:10, fontWeight:"700", letterSpacing:1.5, color:"#3D3935", marginBottom:7 },
  ...
  previewMeta:      { fontSize:12, color:"#3D3935" },
...
const ad = StyleSheet.create({
  ...
  sub:        { fontSize:13, color:"#3D3935", fontWeight:"400", marginBottom:16 },
  fieldLabel: { fontSize:11, fontWeight:"700", letterSpacing:1.4, color:"#3D3935", marginBottom:6 },
          ...
          <View style={s.searchBar}>
            ...
            {searchQuery.length > 0 ? (
              <TouchableOpacity onPress={() => setSearchQuery("")}>
                <Text style={{ fontSize:16, color:"#3D3935" }}>{"\u2715"}</Text>
              </TouchableOpacity>
            ) : null}
          </View>
...
const s = StyleSheet.create({
  ...
  globalSearchClear:   { fontSize:14, color:"#6B6259", paddingLeft:4 },
  ...
  tabPageSub:       { fontSize:13, color:"#3D3935", fontWeight:"400", lineHeight:18 },
  ...
  listMeta:       { fontSize:13, color:"#3D3935", fontWeight:"400" },
  ...
  addDuaSub:     { fontSize:13, color:"#3D3935", fontWeight:"400" },
  ...
  newListBtnTxt: { fontFamily:SERIF, fontSize:16, color:"#3D3935", fontWeight:"400" },
  ...
  searchIcon:      { fontSize:14, color:"#3D3935" },
  ...
  filterChipTxt:   { fontSize:14, color:"#3D3935" },
  ...
  catCount:        { fontSize:14, color:"#3D3935", fontWeight:"400" },

  // Empty state
  empty:      { alignItems:"center", paddingVertical:40 },
  emptyEmoji: { fontSize:40, marginBottom:12 },
  emptyTitle: { fontFamily:SERIF, fontSize:20, color:"#1A1712", marginBottom:8 },
  emptyBody:  { fontSize:16, color:"#3D3935", textAlign:"center", lineHeight:22, paddingHorizontal:16 },
});
