...
const s = StyleSheet.create({
  ...
  headerBtn: {
    ...
    borderRadius:20,
    backgroundColor:"rgba(200,191,178,0.25)",
  },
  headerCenter: {
    flex:1,
    alignItems:"center",
  ...
  // Title — 75% of the large overlay title (39pt × 0.75 ≈ 20pt)
  // but we size it relative to what fits the header: 18pt serif, truncates to 1 line
  headerTitle: {
    fontFamily:SERIF,
    fontSize:18,
    fontWeight:"600",
  ...
  bottomSep: {
    height:1,
    backgroundColor:"rgba(200,191,178,0.50)",
    marginBottom:spacing(1.5),
  },
