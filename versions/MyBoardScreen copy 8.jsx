...
const s = StyleSheet.create({
  ...
  banner:          { flexDirection:"row", alignItems:"center", justifyContent:"center", backgroundColor:"#6A9A80", borderRadius:radius.lg, marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), paddingVertical:spacing(1.5), paddingHorizontal:spacing(2), gap:spacing(1.25), ...shadows.card },
  bannerPlusCircle:{ width:24, height:24, borderRadius:12, borderWidth:1.5, borderColor:"rgba(255,255,255,0.8)", alignItems:"center", justifyContent:"center" },
  bannerPlus:      { fontSize:16, color:"#fff", lineHeight:20 },
  bannerTxt:       { fontFamily:SERIF, fontSize:15, color:"#fff", textAlign:"center" },
