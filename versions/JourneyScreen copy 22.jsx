        ...
        <View style={jn.compactRow}>
          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            <View style={jn.compactIconWrap}>
              <GroupIcon size={32} color={colors.primary} />
            </View>
            <View style={{ flex:1 }}>
          ...
          <TouchableOpacity style={jn.compactCard}
            ...
            activeOpacity={0.88}>
            <View style={jn.compactIconWrap}>
              <ContactIcon size={32} color={colors.primary} />
            </View>
            <View style={{ flex:1 }}>
...
const jn = StyleSheet.create({
  ...
  compactCard:     { flex:1, flexDirection:"row", alignItems:"center", gap:spacing(1.5), backgroundColor:colors.card, borderRadius:radius.lg, borderWidth:1, borderColor:colors.border, padding:spacing(1.75), height:149, ...shadows.card },
  compactIconWrap: { width:56, height:56, borderRadius:radius.md, backgroundColor:"rgba(47,93,80,0.08)", alignItems:"center", justifyContent:"center", flexShrink:0 },
  ...
  compactArrow:    { fontSize:22, color:colors.border, flexShrink:0 },
