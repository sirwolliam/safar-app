...
const row = StyleSheet.create({
  wrap:       { flexDirection:"row", alignItems:"center", paddingHorizontal:16, paddingVertical:14, gap:12, borderBottomWidth:1, borderBottomColor:"#C8BFB2", backgroundColor:"#F5EDE0" },
...
const s = StyleSheet.create({
  ...
  backBtn:     { width:36, height:36, borderRadius:18, backgroundColor:"#F5EDE0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center" },
  ...
  card:        { marginHorizontal:20, backgroundColor:"#F5EDE0", borderRadius:12, borderWidth:1, borderColor:"#C8BFB2", overflow:"hidden", marginBottom:8,
