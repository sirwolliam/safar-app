      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <TouchableOpacity style={s.heroCard} onPress={() => setShowCarousel(true)} activeOpacity={0.9}>
          ...
          >
            ...
            <View style={s.heroCardTop}>
              <View style={s.badge}><Text style={s.badgeTxt}>HAJJ 101</Text></View>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation?.navigate?.("DuaList", {
            list: { id:"hajj", name:"Hajj Du\u02bf\u0101\u02bes", count:23 },
          })}
        >
          <ImageBackground
        ...
        <View style={s.halfRow}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.88}
            onPress={() => navigation?.navigate?.("PilgrimageMap", { initialMode:"hajj" })}
          >
            <ImageBackground
              ...
              resizeMode="cover"
            >
              <View style={[s.halfScrim, { backgroundColor:"rgba(10,24,16,0.42)" }]} />
              <View style={s.halfInner}>
...
const s = StyleSheet.create({
  ...
  // Hero — no borderRadius, full bleed
