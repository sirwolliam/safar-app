...
const s = StyleSheet.create({
  ...
  body: { backgroundColor:colors.background, paddingHorizontal:spacing(2.5), paddingTop:spacing(1), marginTop:spacing(0) },

  // Tiles — +1pt on label and sub
  tilesRow: { flexDirection:"row", gap:spacing(1), marginBottom:spacing(1) },
  ...
  tileSub:  { fontSize:11, color:colors.subtext, fontWeight:"300", lineHeight:15, textAlign:"center" },
