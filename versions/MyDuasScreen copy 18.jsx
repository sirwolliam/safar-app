        ...
        <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
          ...
          <View style={s.tabPageHeaderRow}>
            <View style={{ flex:1 }}>
              ...
              <Text style={s.tabPageSub}>Duas others have shared with me</Text>
            </View>
...
const s = StyleSheet.create({
  ...
  listRow:        { flexDirection:"row", alignItems:"center", paddingVertical:spacing(1.25), paddingRight:spacing(2), gap:spacing(1.5) },
  listRowBorder:  { borderBottomWidth:1, borderBottomColor:colors.border },
  listImgWrap:    { width:64, height:80, flexShrink:0, overflow:"hidden" },
