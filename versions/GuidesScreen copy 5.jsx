...
const jn = StyleSheet.create({
  ...
  // Header
  header:          { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingHorizontal:spacing(2.5), paddingTop:spacing(2), paddingBottom:spacing(1.75), backgroundColor:colors.background },
  headerLeft:      { flex:1 },
