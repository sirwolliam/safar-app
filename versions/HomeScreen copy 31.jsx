...
const s = StyleSheet.create({
  ...
  hero:     { height:HERO_H, justifyContent:"space-between", position:"relative" },
  ...
  // Greeting
  heroGreeting:      { position:"absolute", bottom:100, left:20, right:20 },
  ...
  sectionRow:     { flexDirection:"row", alignItems:"center", gap:10, marginBottom:14, marginTop:26 },
  ...
  explainerWrap:   { marginVertical:8, paddingVertical:10 },
