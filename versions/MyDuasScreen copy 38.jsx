...
const s = StyleSheet.create({
  ...
  // Hero header
  heroWrap:    { marginBottom:20, zIndex:10 },
  heroBg:      { height:260 },
  heroBgImg:   { resizeMode:"cover" },
  heroScrim:   { ...StyleSheet.absoluteFillObject, backgroundColor:"rgba(232,221,208,0.18)" },
  heroContent: { position:"absolute", bottom:50, left:24 },
  headerTitle: { fontFamily:SERIF, fontSize:52, fontWeight:"400", color:"#100E0A", lineHeight:58, letterSpacing:-1 },
  headerSub:   { fontSize:16, color:"#3A3530", fontWeight:"400", marginTop:6, lineHeight:22 },
  // Tab strip — overlaps bottom of hero
  tabStrip:    { position:"absolute", bottom:-28, left:0, right:0, paddingHorizontal:20 },
  ...
  scroll: { paddingHorizontal:20, paddingTop:44 },  // extra top clears tab strip overlap
