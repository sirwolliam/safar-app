          ...
          {JOURNEY_OPTIONS.map((opt) => {
            ...
            return (
              ...
              >
                ...
                <Text style={isSel ? [jts.cardDetail, jts.cardDetailSelected] : jts.cardDetail}>{opt.detail}</Text>
...
const jts = StyleSheet.create({
  root:         { flex: 1, backgroundColor: "#0F2218" },
  dotsRow:      { paddingTop: 16, paddingHorizontal: 30, alignItems: "center" },
  scroll:       { flex: 1 },
  scrollContent:{ paddingHorizontal: 24, paddingTop: 30, paddingBottom: 16 },
  eyebrow:      {
    fontSize: 13, letterSpacing: 2.5, color: T.gold,
    fontWeight: "700", textTransform: "uppercase", marginBottom: 14,
  },
  title:        { fontFamily: SERIF, fontSize: 32, color: "#FFFFFF", lineHeight: 40, marginBottom: 10 },
  sub:          { fontSize: 16, color: "rgba(245,240,232,0.82)", lineHeight: 24, marginBottom: 24 },
  ...
  cardDesc:     { fontSize: 17, color: "#3A3630", fontWeight: "500", marginBottom: 6 },
  cardDetail:   { fontSize: 15, color: "#6A655C", lineHeight: 21, paddingRight: 30 },

  cardLabelSelected:  { color: "#FFFFFF" },
  cardDescSelected:   { color: "rgba(255,255,255,0.92)" },
  cardDetailSelected: { color: "rgba(255,255,255,0.78)" },
  ...
  footer:       { paddingHorizontal: 24, paddingBottom: 44, paddingTop: 16, backgroundColor: "#0F2218" },
  btn:          {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10,
  ...
  btnDisabled:  {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10,
    backgroundColor: "rgba(255,255,255,0.12)", borderRadius: 12, paddingVertical: 17,
  },
  btnTxt:        { fontFamily: SERIF, fontSize: 17, color: "#0F2218", fontWeight: "700" },
  btnTxtDisabled:{ fontFamily: SERIF, fontSize: 17, color: "rgba(255,255,255,0.4)", fontWeight: "500" },
});
