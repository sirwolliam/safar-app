...
const sd = StyleSheet.create({
  ...
  label: { fontFamily:"SourceSerif4-Regular", fontSize:17, fontWeight:"600", color:"#1E3D30", lineHeight:20 },
    ...
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        <View style={jn.pageHeader}>
          ...
          <Text style={jn.pageSub}>{"Plan and prepare for every step with confidence."}</Text>
        </View>
