        ...
        return (
          ...
          >
            <View style={styles.menuIconWrap}>
              <ItemIcon size={20} color={colors.primary} weight="thin" />
            </View>
          ...
          <View style={s.headerTitleRow}>
            ...
            <View style={s.headerIcons}>
              <TouchableOpacity style={s.headerIconBtn}
                ...
                <Question size={18} color="#4A5C48" weight="thin" />
              </TouchableOpacity>
              <TouchableOpacity style={s.headerIconBtn}
                onPress={() => navigation?.navigate?.("Settings")} activeOpacity={0.8}>
                <Gear size={18} color="#4A5C48" weight="thin" />
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View style={s.menuCard}>
            <TouchableOpacity
              ...
              <View style={s.menuIconWrap}>
                <Gear size={22} color="#4A5C48" weight="thin" />
              </View>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}>
              <View style={s.menuIconWrap}>
                <Question size={22} color="#4A5C48" weight="thin" />
              </View>
              <View style={s.menuInfo}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.85}>
              <View style={s.menuIconWrap}>
                <Info size={22} color="#4A5C48" weight="thin" />
              </View>
              <View style={s.menuInfo}>
