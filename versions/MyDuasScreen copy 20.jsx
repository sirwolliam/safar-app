...
const TAB_ITEMS = [
  ...
  { key:"shared",  label:"Shared Duas",   sub:"Duas others have shared with you",   img:require("../assets/tab_shared_duas.jpg")  },
];
...
const tb = StyleSheet.create({
  ...
  textWrap: { padding:spacing(1.25), paddingBottom:spacing(1.5) },
  label:    { fontFamily:SERIF, fontSize:16, color:colors.text, lineHeight:20, marginBottom:3 },
  labelOn:  { color:colors.primary, fontWeight:"600" },
  sub:      { fontSize:13, color:colors.subtext, lineHeight:17 },
...
const s = StyleSheet.create({
  ...
  listRowBorder:  { borderBottomWidth:1, borderBottomColor:"#DDD5C2" },
