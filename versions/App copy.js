...
function PracticeLearnScreen({ navigation }) {
  return (
    <View style={ph.safe}>
      ...
      <Text style={ph.sub}>Audio recitation, repeat mode, and pronunciation guides — coming soon</Text>
    </View>
  );
}
    ...
    <AccessibilityProvider>
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown:false }}>
          ...
          {/* Prepare extras */}
          <Stack.Screen name="CurrencyConverter" component={p => <BackScreen title="Currency Converter" sub="SAR to your home currency" navigation={p.navigation} />} />
          <Stack.Screen name="PrintOffline"      component={p => <BackScreen title="Save for Offline" sub="All duas work without internet" navigation={p.navigation} />} />
          <Stack.Screen name="Bookmarks"         component={p => <BackScreen title="Bookmarks" sub="Your saved duas" navigation={p.navigation} />} />
          <Stack.Screen name="Notes"             component={p => <BackScreen title="Notes" sub="Personal reflections" navigation={p.navigation} />} />
        </Stack.Navigator>
      </NavigationContainer>
    </AccessibilityProvider>
  );
