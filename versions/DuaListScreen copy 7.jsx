...
const row = StyleSheet.create({
  wrap:       { flexDirection:"row", alignItems:"center", paddingHorizontal:16, paddingVertical:14, gap:12, borderBottomWidth:1, borderBottomColor:"#C8BFB2", backgroundColor:"#FDFAF4" },
  wrapLast:   { borderBottomWidth:0 },
  iconWrap:   { width:44, height:44, borderRadius:22, backgroundColor:"#E8DDD0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center", flexShrink:0 },
  icon:       { fontSize:20 },
  info:       { flex:1 },
  title:      { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:3, fontWeight:"400" },
  sub:        { fontSize:12, color:"#3A3530", fontWeight:"400" },
  ...
  chevron:    { fontSize:20, color:"#C8BFB2" },
});
...
const sd = StyleSheet.create({
  ...
  bar:   { width:3, height:18, borderRadius:2, backgroundColor:"#1E3D30" },
...
const s = StyleSheet.create({
  ...
  header:      { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingHorizontal:20, paddingTop:16, paddingBottom:12, borderBottomWidth:1, borderBottomColor:"#C8BFB2", backgroundColor:"#E8DDD0" },
  backBtn:     { width:36, height:36, borderRadius:18, backgroundColor:"#FDFAF4", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center" },
  backArrow:   { fontSize:22, color:"#100E0A", lineHeight:26 },
  headerCenter:{ flex:1, alignItems:"center", paddingHorizontal:8 },
  headerTitle: { fontFamily:SERIF, fontSize:18, color:"#100E0A" },
  headerSub:   { fontSize:12, color:"#3A3530", marginTop:2 },
  card:        { marginHorizontal:20, backgroundColor:"#FDFAF4", borderRadius:12, borderWidth:1, borderColor:"#C8BFB2", overflow:"hidden", marginBottom:8,
    shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.26, shadowRadius:12, elevation:7,},
  empty:       { flex:1, alignItems:"center", justifyContent:"center", padding:24 },
  emptyEmoji:  { fontSize:44, marginBottom:12 },
  emptyTitle:  { fontFamily:SERIF, fontSize:20, color:"#100E0A", marginBottom:8 },
  emptyBody:   { fontSize:14, color:"#3A3530", textAlign:"center", lineHeight:22 },
});
