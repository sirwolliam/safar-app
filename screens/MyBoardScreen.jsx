...
const ps = StyleSheet.create({
  ...
  empty:       { fontSize:13, color:colors.subtext, textAlign:"center", paddingHorizontal:spacing(2), paddingBottom:spacing(2), fontStyle:"italic" },
...
const s = StyleSheet.create({
  ...
  // Add bar
  addBar:        { backgroundColor:"#2F5D50", borderRadius:radius.lg, marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), padding:spacing(1.75), ...shadows.button },
  addBarTop:     { flexDirection:"row", alignItems:"center", gap:spacing(1.25), marginBottom:spacing(1.25) },
  ...
  addBarBtns:    { flexDirection:"row", gap:spacing(0.875) },
  addTypeBtn:    { flex:1, alignItems:"center", paddingVertical:spacing(1.25), borderRadius:radius.md, borderWidth:1, backgroundColor:"rgba(255,255,255,0.12)", gap:4 },
