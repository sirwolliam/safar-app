...
// ── Groups SVG icon ───────────────────────────────────────────────────────────
function GroupIcon({ size = 18, color = "#1E3D30" }) {
  return (
...
function ContactIcon({ size = 18, color = "#1E3D30" }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
const cm = StyleSheet.create({
  ...
  sheet:          { backgroundColor:"#C8DDD4", borderTopLeftRadius:24, borderTopRightRadius:24, paddingHorizontal:20, paddingBottom:16, maxHeight:"88%" },
  ...
  colorSwatchActive:{ borderWidth:2.5, borderColor:"#100E0A" },
  ...
  input:          { backgroundColor:"#F5EDE0", borderRadius:10, borderWidth:1, borderColor:"#C8BFB2", paddingHorizontal:14, paddingVertical:10, fontSize:16, color:"#100E0A", marginBottom:14,
  ...
  roleChip:       { paddingHorizontal:12, paddingVertical:6, borderRadius:999, borderWidth:1, borderColor:"#C8BFB2", backgroundColor:"#F5EDE0" },
  roleChipActive: { backgroundColor:"#1E3D30", borderColor:"#1E3D30" },
...
const bc = StyleSheet.create({
  card:              { borderRadius:10, marginBottom:10, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  checklistCard:     { flexDirection:"row", alignItems:"center", gap:10, backgroundColor:"#F5EDE0", borderWidth:1, borderColor:"#C8BFB2", padding:14 },
  checkbox:          { width:24, height:24, borderRadius:12, borderWidth:1.5, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center", flexShrink:0 },
  checkboxDone:      { backgroundColor:"#1E3D30", borderColor:"#1E3D30" },
  checkmark:         { fontSize:12, color:"#fff", fontWeight:"700" },
  checklistText:     { fontFamily:SERIF, fontSize:16, color:"#100E0A", flex:1 },
  checklistTextDone: { color:"#3A3530", textDecorationLine:"line-through" },
  noteCard:          { backgroundColor:"#FFFBE8", borderWidth:1, borderColor:"#E8DDA0", padding:16 },
  noteIcon:          { fontSize:16, marginBottom:4 },
  noteText:          { fontFamily:SERIF, fontSize:16, color:"#100E0A", lineHeight:16*1.55 },
  ...
  duaPinLabel:       { fontSize:10, fontWeight:"700", letterSpacing:1.5, color:"#1E3D30" },
  duaTitle:          { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:4 },
  duaArabic:         { fontSize:16, color:"#3A3530", textAlign:"right", lineHeight:28, marginBottom:4 },
  duaStage:          { fontSize:12, color:"#1E3D30" },
  linkCard:          { flexDirection:"row", alignItems:"center", gap:10, backgroundColor:"#F5EDE0", borderWidth:1, borderColor:"#C8BFB2", padding:14 },
  ...
  linkTitle:         { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:2 },
  linkUrl:           { fontSize:12, color:"#1E3D30" },
  linkArrow:         { fontSize:16, color:"#1E3D30" },
});
...
const pl = StyleSheet.create({
  wrap:            { flex:1, backgroundColor:"#E8DDD0" },
  header:          { flexDirection:"row", alignItems:"center", gap:8, paddingHorizontal:16, paddingVertical:12, borderBottomWidth:1, borderBottomColor:"#C8BFB2", backgroundColor:"#F5EDE0" },
  iconBtn:         { width:36, height:36, borderRadius:18, backgroundColor:"#E8DDD0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center",
    shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5,},
  iconBtnTxt:      { fontSize:20, color:"#100E0A", lineHeight:24 },
  bookmark:        { fontSize:20, color:"#C8BFB2" },
  ...
  featuredText:    { fontSize:10, color:"#F5EDE0", fontWeight:"700", letterSpacing:1.2 },
  arabicCard:      { backgroundColor:"#F5EDE0", borderRadius:12, borderWidth:1, borderColor:"#C8BFB2", padding:20, marginTop:12, marginBottom:16, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  arabicText:      { fontSize:28, color:"#100E0A", textAlign:"right", lineHeight:52, fontWeight:"400" },
  sectionToggle:   { flexDirection:"row", justifyContent:"space-between", alignItems:"center", paddingVertical:8, borderTopWidth:1, borderTopColor:"#C8BFB2" },
  sectionLabel:    { fontSize:10, fontWeight:"600", color:"#C8A96A", letterSpacing:1.8 },
  sectionChev:     { fontSize:10, color:"#C8BFB2", fontWeight:"600" },
  translitText:    { fontSize:14, color:"#3A3530", fontStyle:"italic", lineHeight:14*1.7, fontWeight:"400", paddingVertical:8 },
  transText:       { fontFamily:SERIF, fontSize:16, color:"#100E0A", lineHeight:16*1.65, fontWeight:"400", paddingVertical:8 },
  sourceText:      { fontSize:12, color:"#3A3530", marginTop:8, opacity:0.7 },
  controls:        { position:"absolute", bottom:0, left:0, right:0, flexDirection:"row", alignItems:"center", justifyContent:"space-around", paddingVertical:16, paddingBottom:24, backgroundColor:"#F5EDE0", borderTopWidth:1, borderTopColor:"#C8BFB2", shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  ctrlBtn:         { alignItems:"center", gap:4, width:64 },
  ctrlBtnDisabled: { opacity:0.3 },
  ctrlIcon:        { fontSize:22, color:"#3A3530" },
  ctrlIconDisabled:{ color:"#C8BFB2" },
  ctrlLabel:       { fontSize:12, color:"#3A3530", fontWeight:"400" },
  playBtn:         { width:64, height:64, borderRadius:32, backgroundColor:"#1E3D30", alignItems:"center", justifyContent:"center", shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  playIcon:        { fontSize:22, color:"#F5EDE0", marginLeft:3 },
});
...
const sr = StyleSheet.create({
  row:           { flexDirection:"row", alignItems:"center", gap:12, paddingVertical:14, paddingHorizontal:16, borderBottomWidth:1, borderBottomColor:"#C8BFB2", backgroundColor:"#F5EDE0" },
  rowLast:       { borderBottomWidth:0 },
  rowActive:     { backgroundColor:"rgba(47,93,80,0.05)" },
  num:           { width:34, height:34, borderRadius:17, backgroundColor:"#C8BFB2", alignItems:"center", justifyContent:"center", flexShrink:0 },
  numDone:       { backgroundColor:"#1E3D30" },
  numActive:     { backgroundColor:"#1E3D30" },
  numText:       { fontSize:14, color:"#3A3530", fontWeight:"500" },
  numTextActive: { color:"#F5EDE0" },
  numTick:       { fontSize:14, color:"#F5EDE0", fontWeight:"700" },
  info:          { flex:1 },
  name:          { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:2 },
  nameActive:    { color:"#1E3D30" },
  nameDone:      { color:"#3A3530" },
  sub:           { fontSize:14, color:"#3A3530", fontWeight:"400" },
  badge:         { backgroundColor:"rgba(47,93,80,0.10)", borderRadius:999, paddingHorizontal:8, paddingVertical:3 },
  badgeText:     { fontSize:12, color:"#1E3D30", fontWeight:"500" },
...
// ── SectionDivider — phase label between card groups ─────────────────────────
...
const sd = StyleSheet.create({
  wrap:  { marginTop:16, marginBottom:18 },
  row:   { flexDirection:"row", alignItems:"center", gap:10, marginBottom:4 },
  bar:   { width:3, height:20, borderRadius:2, backgroundColor:"#1E3D30" },
  label: { fontFamily:"SourceSerif4-Regular", fontSize:17, fontWeight:"700", letterSpacing:0.5, color:"#1E3D30", lineHeight:20 },
  line:  { flex:1, height:1, backgroundColor:"#C8BFB2" },
  sub:   { fontSize:13, color:"#5C534A", fontWeight:"500", marginLeft:13 },
});
...
export default function JourneyScreen({ navigation }) {
  ...
  const [tripConfigured,     setTripConfigured]     = useState(false);
  ...
  useEffect(() => {
    ...
    AsyncStorage.getItem(DEPARTURE_KEY).then(v => { if (v) { setDepartureDateStr(v); setTripConfigured(true); } }).catch(() => {});
    AsyncStorage.getItem("safar_import_dismissed_v1").then(v => { if (v === "1") setImportDismissed(true); }).catch(() => {});
  ...
  const entryDots = Object.keys(calEntries)
    ...
    .reduce((acc, d) => ({ ...acc, [d]: { marked:true, dotColor:"#1E3D30" } }), {});
  ...
  const dismissImport = () => {
    ...
    AsyncStorage.setItem("safar_import_dismissed_v1", "1").catch(() => {});
  };
  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>

        {/* ── Page header ── */}
        <View style={jn.pageHeader}>
          <Text style={jn.arabicBg} allowFontScaling={false}>{"سَفَر"}</Text>
          <View style={jn.pageTitleRow}>
            <View style={{ flex:1 }}>
              <Text style={jn.pageEyebrow}>MY SAFAR</Text>
              <Text style={jn.pageTitle}>My Journey</Text>
              <Text style={jn.pageSub}>{"Plan for every step with confidence."}</Text>
            </View>
            <TouchableOpacity style={jn.calIconBtn}
              onPress={() => setShowCalendar(true)} activeOpacity={0.85}>
              <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
                <Rect x="3" y="4" width="18" height="17" rx="2" stroke="#1E3D30" strokeWidth="1.8" />
                <Path d="M3 9h18" stroke="#1E3D30" strokeWidth="1.8" strokeLinecap="round"/>
                <Path d="M8 2v4M16 2v4" stroke="#1E3D30" strokeWidth="1.8" strokeLinecap="round"/>
                <Path d="M7 13h2M11 13h2M15 13h2M7 17h2M11 17h2M15 17h2" stroke="#1E3D30" strokeWidth="1.6" strokeLinecap="round"/>
              </Svg>
            </TouchableOpacity>
          </View>
        </View>
        ...
        {/* ── Smart Import card — shown until explicitly dismissed ── */}
        {!importDismissed && (
          <TouchableOpacity style={jn.importCard}
            onPress={() => navigation?.navigate?.("ImportTrip")}
            activeOpacity={0.88}>
            <View style={jn.importCardLeft}>
              <Text style={jn.importCardEyebrow}>{"AI-POWERED"}</Text>
              <Text style={jn.importCardTitle}>{"Set Up My Journey"}</Text>
              <Text style={jn.importCardSub}>{"Scan your booking confirmation and Safar fills in your dates, accommodation and contacts — automatically."}</Text>
              <TouchableOpacity style={jn.importCardCta}
                onPress={() => navigation?.navigate?.("ImportTrip")} activeOpacity={0.85}>
                <Text style={jn.importCardCtaTxt}>{"Try it now →"}</Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity onPress={dismissImport}
              hitSlop={{top:12,bottom:12,left:12,right:12}}
              style={{ paddingLeft:8, paddingTop:0, alignSelf:"flex-start" }}>
              <Text style={{ fontSize:16, color:"rgba(255,255,255,0.40)", fontWeight:"400" }}>{"✕"}</Text>
            </TouchableOpacity>
          </TouchableOpacity>
        )}
        ...
        {/* ════════════════════════════════════════════════════════════════════
            BEFORE YOU GO
        ════════════════════════════════════════════════════════════════════ */}
        <SectionDivider label="Before You Go" sub="Plan, track and prepare before you travel" />

        {/* Calendar card — tap left to open calendar, chevron to expand entries */}
        <View style={jn.datesCardWrap}>
          {/* Main card row — tap to open calendar */}
          <TouchableOpacity style={jn.datesCardMain} onPress={() => setShowCalendar(true)} activeOpacity={0.88}>
          ...
          {/* Chevron strip at bottom — only when entries exist */}
          {Object.keys(calEntries).filter(d => (calEntries[d] ?? []).length > 0).length > 0 && (
            <TouchableOpacity style={jn.datesCardChevStrip}
              onPress={() => setShowEntries(v => !v)} activeOpacity={0.8}>
              <Text style={jn.datesCardChevLabel}>
                {Object.values(calEntries).flat().length} {Object.values(calEntries).flat().length === 1 ? "note" : "notes"}
              </Text>
              <Text style={jn.datesCardChevTxt}>{showEntries ? "▲" : "▼"}</Text>
            </TouchableOpacity>
          )}

          {/* Expandable entries dropdown */}
          {showEntries && (
            <View style={jn.datesEntriesBody}>
              <View style={jn.datesEntriesExplainer}>
                <Text style={jn.datesEntriesExplainerTxt}>
                  {"Tap the calendar to add more notes. Tap × to remove an entry."}
                </Text>
              </View>
          ...
          <ImageBackground
            ...
            <View style={jn.wideCardContent}>
              <View style={jn.wideCardTopRow}>
                <View style={{ flex:1 }} />
                <View style={jn.arrowCircle}><Text style={jn.wideCardArrow}>{"›"}</Text></View>
              </View>
              <View>
        ...
        <TouchableOpacity style={jn.checklistHeader} onPress={() => setChecklistOpen(v => !v)} activeOpacity={0.85}>
          <ImageBackground
            source={mode === "hajj" ? require("../assets/07_arafah_gradient.jpg") : require("../assets/checklist_kaaba.jpg")}
            ...
            <View style={jn.wideCardContent}>
              <View style={jn.wideCardTopRow}>
                <View style={jn.guideCardBadge}>
                  <Text style={jn.guideCardBadgeTxt}>{mode === "umrah" ? "UMRAH 101" : "HAJJ 101"}</Text>
                </View>
                <View style={jn.arrowCircle}><Text style={jn.wideCardArrow}>{"›"}</Text></View>
              </View>
              <View>
          ...
          <ImageBackground
            ...
            <View style={jn.wideCardContent}>
              ...
              <View style={jn.wideCardBottomRow}>
                ...
                <View style={jn.arrowCircle}><Text style={jn.wideCardArrowBottom}>{"›"}</Text></View>
              </View>
            </View>
          </ImageBackground>
        </TouchableOpacity>
        ...
        <View style={jn.pairRow}>
          ...
          <TouchableOpacity style={jn.pairCard}
            ...
            <ImageBackground
              ...
              <View style={jn.pairArrow}><Text style={{ fontSize:14, color:"rgba(255,255,255,0.75)" }}>{"›"}</Text></View>
      ...
      {/* ── Calendar modal — centred dialog ── */}
      <Modal visible={showCalendar} animationType="fade" transparent
        onRequestClose={() => { setShowCalendar(false); setAddingEntry(null); }}>
        ...
        >
          {/* Dialog — tap inside does NOT close */}
          <TouchableOpacity
            style={jn.calSheet}
            activeOpacity={1}
          ...
          >
            ...
            <View style={jn.calLegend}>
              <View style={jn.calLegendItem}>
                <View style={[jn.calLegendDot, { backgroundColor:"#1E3D30" }]} />
                <Text style={jn.calLegendTxt}>Departure</Text>
              </View>
              <View style={jn.calLegendItem}>
                <View style={[jn.calLegendDot, { backgroundColor:"#C8A96A" }]} />
                <Text style={jn.calLegendTxt}>Hajj dates</Text>
              </View>
              <View style={jn.calLegendItem}>
                <View style={[jn.calLegendDot, { backgroundColor:"#3B6B58" }]} />
                <Text style={jn.calLegendTxt}>Has notes</Text>
              </View>
            </View>
            ...
            <Calendar
              ...
              theme={{
                ...
                calendarBackground: "#F5EDE0",
                textSectionTitleColor: "#5C534A",
                selectedDayBackgroundColor: "#1E3D30",
                selectedDayTextColor: "#fff",
                todayTextColor: "#1E3D30",
                todayBackgroundColor: "#E2EDE6",
                dayTextColor: "#100E0A",
                textDisabledColor: "#C4C0BA",
                dotColor: "#C8A96A",
                selectedDotColor: "#C8A96A",
                arrowColor: "#1E3D30",
                monthTextColor: "#100E0A",
            ...
            <View style={jn.calNote}>
              <Text style={jn.calNoteTxt}>
                {"Gold dots mark estimated Hajj 1446 AH dates. Verify with your local authority."}
              </Text>
            </View>
...
const jn = StyleSheet.create({
  ...
  // ── Page header ─────────────────────────────────────────────────────────────
  pageHeader:    { paddingTop:16, paddingBottom:12, paddingHorizontal:2, position:"relative", overflow:"hidden" },
  arabicBg:      { position:"absolute", right:-8, top:-4, fontSize:108, color:"#1E3D30", opacity:0.06, lineHeight:128 },
  pageEyebrow:   { fontSize:9, fontWeight:"800", letterSpacing:3, color:"#3B6B58", marginBottom:6 },
  pageTitle:     { fontFamily:SERIF, fontSize:28, fontWeight:"600", color:"#100E0A", flex:1, marginBottom:3 },
  pageSub:       { fontSize:14, color:"#3A3530", lineHeight:20, fontWeight:"500", maxWidth:"68%", marginTop:0 },
  departureBadge:{ alignItems:"center", backgroundColor:"#F5EDE0", borderRadius:10, borderWidth:1, borderColor:"#B8922A", paddingHorizontal:12, paddingVertical:5, marginLeft:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.10, shadowRadius:4, elevation:2 },
  departureDays: { fontFamily:SERIF, fontSize:20, color:"#100E0A", fontWeight:"400" },
  departureLbl:  { fontSize:9, color:"#3A3530", textAlign:"center", letterSpacing:0.3 },
  ...
  modeOptActive:  { backgroundColor:"#1E3D30" },
  modeName:       { fontFamily:SERIF, fontSize:19, color:"#3A3530", fontWeight:"400", letterSpacing:1 },
  modeNameActive: { color:"#fff", fontWeight:"600" },
  modeSub:        { fontSize:13, color:"#3A3530", fontWeight:"400", textAlign:"center" },
  ...
  calIconBtn:      { width:44, height:44, borderRadius:12, borderWidth:1.5, borderColor:"#C8BFB2", backgroundColor:"#FDFAF4", alignItems:"center", justifyContent:"center", marginTop:4, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.12, shadowRadius:4, elevation:2 },
  calIconBtnTxt:   { fontFamily:SERIF, fontSize:15, color:"#1E3D30", fontWeight:"700", lineHeight:17 },
  calIconBtnBar:   { width:24, height:2.5, backgroundColor:"#1E3D30", borderRadius:1, marginTop:2 },

  // ── Import card ──────────────────────────────────────────────────────────────
  importCard:        { flexDirection:"row", alignItems:"center", backgroundColor:"#1E3D30", borderRadius:16, padding:18, marginBottom:14, gap:14, shadowColor:"#4A2E10", shadowOffset:{width:0,height:5}, shadowOpacity:0.26, shadowRadius:12, elevation:7 },
  importCardLeft:    { flex:1 },
  importCardEyebrow: { fontSize:9, fontWeight:"800", letterSpacing:2.5, color:"#C8A96A", marginBottom:5 },
  importCardTitle:   { fontFamily:SERIF, fontSize:20, color:"#fff", marginBottom:6, fontWeight:"600" },
  importCardSub:     { fontSize:13, color:"rgba(255,255,255,0.72)", fontWeight:"400", lineHeight:18, marginBottom:12 },
  importCardCta:     { alignSelf:"flex-start", borderWidth:1, borderColor:"rgba(255,255,255,0.35)", borderRadius:20, paddingHorizontal:14, paddingVertical:6 },
  importCardCtaTxt:  { fontSize:13, color:"rgba(255,255,255,0.90)", fontWeight:"600" },

  // ── Entries card (below calendar card) ──────────────────────────────────────
  entriesCard:         { backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:8, elevation:4, maxHeight:280 },
  entriesCardHeader:   { paddingHorizontal:16, paddingTop:14, paddingBottom:10, borderBottomWidth:1, borderBottomColor:"#E8E0D4" },
  entriesCardTitle:    { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:2 },
  entriesCardSub:      { fontSize:12, color:"#5C534A" },
  entriesCardScroll:   { paddingHorizontal:16 },

  // ── Dates card ──────────────────────────────────────────────────────────────
  datesCardWrap:      { backgroundColor:"#EDE9D8", borderRadius:16, borderWidth:1, borderColor:"#D4D0C4", marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.12, shadowRadius:8, elevation:4, overflow:"hidden" },
  datesCardMain:      { flexDirection:"row", alignItems:"center", padding:18, gap:12 },
  datesCardChevStrip: { flexDirection:"row", alignItems:"center", justifyContent:"center", gap:8, paddingVertical:9, borderTopWidth:1, borderTopColor:"#C8BFB2", backgroundColor:"#F8F5EF" },
  datesCardChevTxt:   { fontSize:11, color:"#3A3530", fontWeight:"600" },
  datesCardChevLabel: { fontSize:12, color:"#3A3530" },
  datesEntriesBody:   { borderTopWidth:1, borderTopColor:"#C8BFB2", paddingHorizontal:16 },
  datesEntriesExplainer: { paddingHorizontal:16, paddingVertical:10, backgroundColor:"#F5F2EC", marginHorizontal:-16, marginBottom:8 },
  datesEntriesExplainerTxt: { fontSize:12, color:"#3A3530" },
  datesCard:          { flexDirection:"row", alignItems:"center", backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", marginBottom:12, padding:18, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.12, shadowRadius:8, elevation:4, gap:12 },
  datesCardLeft:    { flex:1 },
  datesCardDivider: { width:1, alignSelf:"stretch", backgroundColor:"#C8BFB2", marginHorizontal:4 },
  datesCardEyebrow: { fontSize:18, fontFamily:SERIF, fontWeight:"600", color:"#1E3D30", marginBottom:4 },
  datesCardTitle:   { fontFamily:SERIF, fontSize:20, color:"#100E0A", marginBottom:4 },
  datesCardSub:     { fontSize:13, color:"#3A3530", lineHeight:18 },
  datesCardRight:   { alignItems:"center", gap:2, minWidth:72 },
  datesCardDayNum:  { fontFamily:SERIF, fontSize:52, color:"#1E3D30", lineHeight:58, fontWeight:"400" },
  datesCardMonthYr: { fontFamily:SERIF, fontSize:13, color:"#3A3530", textAlign:"center", lineHeight:17 },
  datesCardDays:    { fontSize:11, color:"#5C534A", textAlign:"center", marginTop:2 },

  // ── Calendar sheet ───────────────────────────────────────────────────────────
  calOverlay:      { flex:1, backgroundColor:"rgba(0,0,0,0.52)", justifyContent:"center", alignItems:"center", paddingHorizontal:16, paddingVertical:40 },
  calSheet:        { backgroundColor:"#F5EDE0", borderRadius:20, width:"100%", paddingHorizontal:20, paddingTop:4, paddingBottom:20, shadowColor:"#1A1208", shadowOffset:{width:0,height:8}, shadowOpacity:0.28, shadowRadius:24, elevation:16 },
  calHandle:       { display:"none" },
  calHeader:       { flexDirection:"row", alignItems:"flex-start", justifyContent:"space-between", paddingTop:10, paddingBottom:12 },
  calTitle:        { fontFamily:SERIF, fontSize:20, color:"#100E0A" },
  calSub:          { fontSize:13, color:"#3A3530", marginTop:2 },
  calCloseBtn:     { backgroundColor:"#1E3D30", borderRadius:20, paddingHorizontal:16, paddingVertical:8 },
  calCloseTxt:     { fontSize:14, color:"#fff", fontWeight:"500" },
  calLegend:       { flexDirection:"row", gap:16, paddingBottom:10, borderBottomWidth:1, borderBottomColor:"#DDD5C8", marginBottom:8, flexWrap:"wrap" },
  calLegendItem:   { flexDirection:"row", alignItems:"center", gap:6 },
  calLegendDot:    { width:8, height:8, borderRadius:4 },
  calLegendTxt:    { fontSize:12, color:"#3A3530" },
  calDayLabel:     { flexDirection:"row", alignItems:"center", gap:8, backgroundColor:"#E2EDE6", borderRadius:10, marginHorizontal:4, marginTop:8, padding:12 },
  calDayLabelIcon: { fontSize:16 },
  calDayLabelTxt:  { fontFamily:SERIF, fontSize:14, color:"#100E0A", flex:1 },
  calNote:              { backgroundColor:"#EEE4CB", borderRadius:10, borderWidth:1, borderColor:"#DDD0A8", padding:12, marginTop:12 },
  calNoteTxt:           { fontSize:11, color:"#6B5020", lineHeight:17 },
  calFixed:             { backgroundColor:"#F5EDE0", paddingHorizontal:0, flexShrink:0 },
  calDivider:           { height:1, backgroundColor:"#DDD5C8", marginTop:4, marginBottom:0 },
  calEntriesScroll:     { flex:1, paddingHorizontal:20, minHeight:120 },
  calEntriesContent:    { paddingTop:12, paddingBottom:8 },
  calEntriesEmpty:      { fontSize:14, color:"#5C534A", textAlign:"center", paddingVertical:20, fontStyle:"italic" },
  calEntryInputWrap:    { backgroundColor:"#E2EDE6", borderRadius:12, marginTop:10, padding:12 },
  calEntryDateHdr:      { fontFamily:SERIF, fontSize:14, color:"#100E0A", marginBottom:8 },
  calEntryInputRow:     { flexDirection:"row", gap:8, alignItems:"center" },
  calEntryInput:        { flex:1, backgroundColor:"#F5EDE0", borderRadius:10, borderWidth:1, borderColor:"#C8DDD0", paddingHorizontal:12, paddingVertical:10, fontSize:15, color:"#100E0A" },
  calEntrySaveBtn:      { backgroundColor:"#1E3D30", borderRadius:10, paddingHorizontal:14, paddingVertical:10 },
  calEntrySaveTxt:      { fontSize:14, color:"#fff", fontWeight:"500" },
  calEntryGroup:        { marginHorizontal:4, marginTop:12 },
  calEntryGroupDate:    { fontFamily:SERIF, fontSize:15, color:"#1E3D30", marginBottom:6, paddingBottom:4, borderBottomWidth:1, borderBottomColor:"#DDD5C8" },
  calEntryRow:          { flexDirection:"row", alignItems:"flex-start", gap:8, paddingVertical:5 },
  calEntryDot:          { width:5, height:5, borderRadius:3, backgroundColor:"#1E3D30", marginTop:7, flexShrink:0 },
  calEntryTxt:          { flex:1, fontSize:16, color:"#100E0A", lineHeight:22 },
  ...
  wideCard:        { borderRadius:16, overflow:"hidden", height:160, marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  wideCardBg:      { flex:1 },
  ...
  // ── Checklist dropdown ───────────────────────────────────────────────────────
  checklistHeader:        { borderRadius:16, overflow:"hidden", marginBottom:12, height:96, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  ...
  checklistBody:          { backgroundColor:"#F5EDE0", borderRadius:14, borderWidth:1, borderColor:"#C8BFB2", overflow:"hidden", marginBottom:20, shadowColor:"#4A2E10", shadowOffset:{width:0,height:2}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  checklistExplainer:     { flexDirection:"row", alignItems:"flex-start", gap:8, paddingHorizontal:14, paddingVertical:12, backgroundColor:"#EEE4CB", borderBottomWidth:1, borderBottomColor:"#DDD0A8" },
  checklistExplainerIcon: { fontSize:14, marginTop:1 },
  checklistExplainerTxt:  { flex:1, fontSize:12, color:"#6B5020", lineHeight:18 },
  checkAddRow:            { flexDirection:"row", alignItems:"center", gap:10, paddingHorizontal:14, paddingVertical:14, borderTopWidth:1, borderTopColor:"#C8BFB2" },
  checkAddActive:         { paddingHorizontal:14, paddingVertical:12, borderTopWidth:1, borderTopColor:"#C8BFB2" },
  checkAddIcon:           { width:22, height:22, borderRadius:11, borderWidth:1.5, borderStyle:"dashed", borderColor:"#1E3D30", alignItems:"center", justifyContent:"center", flexShrink:0 },
  checkAddPlus:           { fontSize:14, color:"#1E3D30", lineHeight:18 },
  checkAddTxt:            { fontFamily:SERIF, fontSize:14, color:"#1E3D30" },
  ...
  checkInput:             { flex:1, fontFamily:SERIF, fontSize:14, color:"#100E0A", borderBottomWidth:1.5, borderBottomColor:"#1E3D30", paddingVertical:2 },
  checkEditIcon:          { fontSize:14, color:"#C8BFB2", paddingLeft:4 },

  // ── Pair row: Contacts (left) + Groups (right) ───────────────────────────────
  pairRow:         { flexDirection:"row", gap:12, marginBottom:12, marginTop:13 },
  pairCard:        { flex:1, borderRadius:16, overflow:"hidden", height:150, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  pairCardBg:      { flex:1 },
  ...
  pairArrow:        { position:"absolute", top:12, right:12, width:28, height:28, borderRadius:14, backgroundColor:"rgba(255,255,255,0.30)", alignItems:"center", justifyContent:"center" },
  arrowCircle:       { width:30, height:30, borderRadius:15, backgroundColor:"rgba(255,255,255,0.30)", alignItems:"center", justifyContent:"center" },
  ...
  fullRowCard:         { flex:1, borderRadius:16, overflow:"hidden", height:150, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  fullRowCardImg:      { flex:1, justifyContent:"flex-end" },
  compactRow:          { flexDirection:"row", gap:12, marginBottom:12 },
  compactCard:         { flex:1, justifyContent:"flex-end", backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", padding:16, height:120, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  compactTitle:        { fontFamily:SERIF, fontSize:17, color:"#100E0A", fontWeight:"500", marginBottom:4 },
  compactSub:          { fontSize:14, color:"#3A3530", lineHeight:18 },
  halfRow:             { flexDirection:"row", gap:12, marginBottom:12 },
  halfCard:            { flex:1, borderRadius:16, overflow:"hidden", height:150, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  halfCardImg:         { flex:1, justifyContent:"flex-end" },
  guideCard:           { borderRadius:16, overflow:"hidden", height:160, marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  guideCardBg:         { flex:1 },
  ...
  linkCard:            { flexDirection:"row", alignItems:"center", backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", marginBottom:10, padding:16, gap:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  linkIconWrap:        { width:48, height:48, borderRadius:10, backgroundColor:"#E8DDD0", borderWidth:1, borderColor:"#C8BFB2", alignItems:"center", justifyContent:"center", flexShrink:0 },
  linkIcon:            { fontSize:22 },
  linkInfo:            { flex:1 },
  linkLabel:           { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:3 },
  linkSub:             { fontSize:13, color:"#3A3530", fontWeight:"400" },
  linkArrow:           { fontSize:20, color:"#C8BFB2" },
  linkCounter:         { alignItems:"center", justifyContent:"center", minWidth:40 },
  linkCounterNum:      { fontFamily:SERIF, fontSize:18, color:"#1E3D30", fontWeight:"500", lineHeight:22 },
  linkCounterOf:       { fontSize:10, color:"#3A3530", textAlign:"center" },
  heroCard:            { borderRadius:20, overflow:"hidden", marginBottom:14, height:260, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  heroCardBg:          { flex:1 },
  ...
  heroCardBadgeTxt:    { fontFamily:SERIF, fontSize:13, color:"#1E3D30", fontWeight:"700", letterSpacing:1 },
  ...
  boardCard:           { borderRadius:20, overflow:"hidden", marginBottom:14, height:150, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5 },
  boardCardBg:         { flex:1 },
  ...
  header:              { flexDirection:"row", alignItems:"center", justifyContent:"space-between", paddingHorizontal:20, paddingVertical:14, backgroundColor:"#E8DDD0" },
  headerLeft:          { flex:1 },
  headerTitle:         { fontFamily:SERIF, fontSize:26, fontWeight:"400", color:"#100E0A" },
  headerSub:           { fontSize:14, color:"#3A3530", fontWeight:"400", marginTop:2 },
  departureBadge:      { alignItems:"center", paddingHorizontal:12, paddingVertical:6, borderWidth:1, borderColor:"#B8922A", borderRadius:10 },
  departureDays:       { fontFamily:SERIF, fontSize:22, color:"#100E0A", fontWeight:"400", lineHeight:26 },
  departureLbl:        { fontSize:10, color:"#3A3530", textAlign:"center", lineHeight:13, letterSpacing:0.3 },
