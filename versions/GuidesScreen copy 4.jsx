  ...
  return (
    <>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* ── 4. Sacred Places + Pilgrimage Route Map — real images ── */}
        <View style={jn.halfRow}>
            ...
            <ImageBackground
              ...
              <View style={jn.halfCardOverlayWrap}>
                ...
                <View style={jn.halfCardOverlay}>
                  ...
                  <Text style={jn.halfCardSubWhite}>Du'ās for each location</Text>
                </View>
              </View>
            </ImageBackground>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={jn.halfCard}
            ...
            <ImageBackground
              ...
              <View style={jn.halfCardOverlayWrap}>
                <View style={jn.halfCardCountWrap}>
                  <Text style={jn.halfCardCount}>6</Text>
                  <Text style={jn.halfCardCategory}>stages</Text>
                </View>
                <View style={jn.halfCardOverlay}>
                  <Text style={jn.halfCardCategory}>ROUTE MAP</Text>
                  <Text style={jn.halfCardTitleWhite}>Pilgrimage Map</Text>
                  <Text style={jn.halfCardSubWhite}>Interactive route guide</Text>
                </View>
              </View>
            </ImageBackground>
          </TouchableOpacity>
