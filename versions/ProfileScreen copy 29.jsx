...
const createStyles = (colors) => StyleSheet.create({
  ...
  shelf:             { backgroundColor:"#EBF2EE", borderBottomWidth:1, borderBottomColor:"#C8DDD0", paddingHorizontal:spacing(2.5), paddingVertical:spacing(1), paddingBottom:spacing(1.25), flexDirection:"row", flexWrap:"wrap", gap:spacing(0.625), marginBottom:spacing(1.5) },
  shelfItem:         { width:"32%", paddingVertical:spacing(1.25), borderRadius:radius.md, alignItems:"center", justifyContent:"center", backgroundColor:"transparent" },
  ...
  sectionTitle:  { fontFamily:SERIF, fontSize:18, fontWeight:"600", color:colors.text },
  ...
  affiliateDisclosure: { fontSize:12, color:colors.subtext, fontStyle:"italic", marginHorizontal:spacing(2.5), marginBottom:spacing(1), lineHeight:16 },
  ...
  affiliateTitle:      { fontFamily:SERIF, fontSize:14, color:colors.text, lineHeight:17 },
  affiliateSub:        { fontSize:12, color:colors.subtext, lineHeight:15, flex:1 },
