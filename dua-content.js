...
export const DUA_CONTENT = {
  ...
  anew:       byTag("anew"),
  scared:      byTag("scared"),
  nervous:     byTag("nervous"),
  overwhelmed: byTag("overwhelmed"),
  tired:       byTag("tired"),
  lazy:        byTag("lazy"),
  bored:       byTag("bored"),
  sad:        byTag("sad"),
  depressed:  byTag("depressed"),
  hurt:       byTag("hurt"),
  lonely:     byTag("lonely"),
  unloved:    byTag("unloved"),
  regret:     byTag("regret"),
  angry:        byTag("angry"),
  impatient:    byTag("impatient"),
  jealous:      byTag("jealous"),
  greedy:       byTag("greedy"),
  doubtful:     byTag("doubtful"),
  hypocritical: byTag("hypocritical"),
  guilty:       byTag("guilty"),
  indecisive:   byTag("indecisive"),
  weak:         byTag("weak"),
  confused:     byTag("confused"),
  content:      byTag("content"),
  happy:        byTag("happy"),
};
