...
const nc = StyleSheet.create({
  card:         { flex:1, backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#DDD5C8", padding:14, alignItems:"flex-start", shadowColor:"#100E0A", shadowOffset:{width:0,height:2}, shadowOpacity:0.06, shadowRadius:6, elevation:2 },
  cardActive:   { backgroundColor:"#1E3D30", borderColor:"#1E3D30", shadowColor:"#1A3A2A", shadowOpacity:0.18, elevation:5 },
  iconWrap:     { position:"relative", marginBottom:12 },
  iconCircle:   { width:52, height:52, borderRadius:26, backgroundColor:"#E8E0D4", alignItems:"center", justifyContent:"center" },
  ...
  label:        { fontFamily:SERIF, fontSize:16, color:"#100E0A", marginBottom:6, lineHeight:20 },
  labelActive:  { color:"#fff" },
  sub:          { fontSize:13, color:"#3A3530", lineHeight:18, marginBottom:10, minHeight:54 },
...
const tb = StyleSheet.create({
  container: { backgroundColor:"#E8E0D4", borderRadius:20, marginHorizontal:20, marginBottom:16, padding:10, shadowColor:"#100E0A", shadowOffset:{width:0,height:2}, shadowOpacity:0.16, shadowRadius:10, elevation:4 },
...
export default function MyDuasScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      {/* Global search — hidden on library tab which has its own browse UI */}
      {activeTab !== "library" && <View style={s.globalSearchWrap}>
