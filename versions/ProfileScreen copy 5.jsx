...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      {/* Category chips — tap to jump to section */}
      <ScrollView
        horizontal
...
const createStyles = (colors) => StyleSheet.create({
  ...
  chipsRow:    { paddingHorizontal:spacing(2.5), paddingBottom:spacing(1.5), gap:spacing(0.875) },
  chip:        { paddingHorizontal:spacing(1.75), paddingVertical:spacing(0.875), borderRadius:radius.pill, backgroundColor:colors.card, borderWidth:1, borderColor:colors.border, ...shadows.card },
