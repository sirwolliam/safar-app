  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <View style={s.headerRight}>
          ...
          <TouchableOpacity onPress={() => setBookmarked(b => !b)} style={s.iconBtn}>
            <Text style={bookmarked ? [s.iconBtnText, s.bookmarkedIcon] : s.iconBtnText}>
              {bookmarked ? "♥" : "♡"}
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.fontRow}>
          ...
          <View style={s.fontBtns}>
            {[["sm","A"],["md","A"],["lg","A"]].map(([key, label], i) => (
              <TouchableOpacity
                key={key}
                style={fontSize === key ? [s.fontBtn, s.fontBtnActive] : s.fontBtn}
        ...
        {/* Audio player — only shown when audio files exist for this dua */}
        {AUDIO_FILES && AUDIO_FILES[dua.id] && (
        ...
        <View style={s.togglesCard}>
          ...
          {[
            ...
            <View key={label} style={s.toggleRow}>
              ...
              <TouchableOpacity
                style={val ? [s.toggle, s.toggleOn] : s.toggle}
                onPress={() => setter(v => !v)}
              >
                <View style={val ? [s.knob, s.knobOn] : s.knob} />
              </TouchableOpacity>
            </View>
          ))}
        </View>
