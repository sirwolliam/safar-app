...
const DHIKRS = [
  ...
  { id:"rabbighfirli",           arabic:"رَبِّ اغْفِرْ لِي",                                           translit:"Rabbighfir li",                        en:"My Lord, forgive me",                         target:100, meaning:"A direct personal supplication to Allah for forgiveness. Simple, sincere, and deeply powerful.",                                                            significance:"A du'a that can be said constantly, especially during Tawaf and Sa'i. The Prophet ﷺ recommended continuous istighfar." },
  { id:"yaallah",                arabic:"يَا اللَّهُ",                                                  translit:"Ya Allah",                             en:"O Allah",                                     target:100, meaning:"Calling upon Allah directly by His greatest name. An intimate and direct address to the Creator.",                                                           significance:"Calling on Allah by name is among the most intimate forms of dhikr and du'a. It opens the heart." },
  ...
  { id:"allahummainnaka",        arabic:"اللَّهُمَّ إِنَّكَ عَفُوٌّ تُحِبُّ الْعَفْوَ",             translit:"Allahumma innaka 'afuwwun tuhibbul 'afwa fa'fu 'anni", en:"O Allah, You are forgiving, so forgive me", target:100, meaning:"A du'a for forgiveness — especially recommended in Laylatul Qadr and during pilgrimage when du'as are most answered.", significance:"The Prophet ﷺ taught this du'a to Aisha when she asked what to say on Laylatul Qadr. (Tirmidhi 3513)" },
];
