...
const jn = StyleSheet.create({
  ...
  // ── Dates card ──────────────────────────────────────────────────────────────
  datesCardWrap:      { backgroundColor:"#F5EDE0", borderRadius:16, borderWidth:1, borderColor:"#C8BFB2", marginBottom:12, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.12, shadowRadius:8, elevation:4, overflow:"hidden" },
  ...
  calSheet:        { backgroundColor:"#F5EDE0", borderTopLeftRadius:24, borderTopRightRadius:24, maxHeight:"88%", minHeight:480, paddingHorizontal:24, paddingBottom:40 },
  calHandle:       { width:36, height:4, borderRadius:2, backgroundColor:"#C8BFB2", alignSelf:"center", marginTop:12, marginBottom:8 },
  ...
  calFixed:             { backgroundColor:"#F5EDE0", paddingHorizontal:20, borderTopLeftRadius:24, borderTopRightRadius:24, flexShrink:0 },
