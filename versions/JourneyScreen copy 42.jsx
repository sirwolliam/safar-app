  ...
  return (
    <SafeAreaView style={jn.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex:1 }} contentContainerStyle={jn.scroll}>
        ...
        {/* Journey notes card — visible only when entries exist */}
        {Object.keys(calEntries).filter(d => (calEntries[d] ?? []).length > 0).length > 0 && (
          <View style={jn.entriesCard}>
            <View style={jn.entriesCardHeader}>
              <Text style={jn.entriesCardTitle}>Journey Notes</Text>
              <Text style={jn.entriesCardSub}>{Object.values(calEntries).flat().length} notes across your dates</Text>
            </View>
            <ScrollView
              style={jn.entriesCardScroll}
...
const jn = StyleSheet.create({
  ...
  calSheet:        { backgroundColor:"#FDFAF4", borderTopLeftRadius:24, borderTopRightRadius:24, borderBottomLeftRadius:0, borderBottomRightRadius:0 },
