...
const ml = StyleSheet.create({
  ...
  sheet:       { backgroundColor:"#F0EBE0", borderTopLeftRadius:radius.xl, borderTopRightRadius:radius.xl, padding:spacing(2.5), paddingBottom:spacing(5) },
  sheetHeader: { flexDirection:"row", alignItems:"center", justifyContent:"space-between", marginBottom:spacing(2) },
  cancel:      { fontSize:16, color:colors.subtext },
  sheetTitle:  { fontFamily:SERIF, fontSize:16, color:colors.text },
  save:        { fontSize:16, color:colors.primary, fontWeight:"600" },
  saveDisabled:{ opacity:0.35 },
  tipCard:     { flexDirection:"row", gap:spacing(1), backgroundColor:"#EBF2EE", borderRadius:radius.md, borderWidth:1, borderColor:"#C8DDD0", padding:spacing(1.5), marginBottom:spacing(2) },
  ...
  input:       { backgroundColor:colors.background, borderRadius:radius.md, borderWidth:1, borderColor:colors.border, paddingHorizontal:spacing(1.75), paddingVertical:spacing(1.25), fontSize:16, color:colors.text, marginBottom:spacing(2),
    ...shadows.card,},
...
const createStyles = (colors) => StyleSheet.create({
  ...
  tabs: { flexDirection:"row", marginHorizontal:spacing(2.5), marginBottom:spacing(1.5), backgroundColor:colors.card, borderRadius:radius.md, padding:3, borderWidth:1, borderColor:colors.border,
    ...shadows.card,},
  ...
  emptyBody:  { fontSize:16, color:colors.subtext, textAlign:"center", lineHeight:22 },

  scroll:       { paddingHorizontal:spacing(2.5) },
  stageSection: { marginBottom:spacing(2) },
  stageLabel:   { fontFamily:SERIF, fontSize:14, fontWeight:"600", color:colors.accent, letterSpacing:1, marginBottom:spacing(1), marginTop:spacing(1.5) },
  ...
  duaInfo:      { flex:1 },
  duaTitle:     { fontFamily:SERIF, fontSize:16, color:colors.text, marginBottom:3 },
  ...
  shareHintTitle:{ fontFamily:SERIF, fontSize:14, color:colors.text, marginBottom:2 },
  shareHintBody: { fontSize:12, color:colors.subtext, lineHeight:16 },
  ...
  shareHintBtnText:{ fontSize:14, color:"#fff", fontWeight:"600" },
  ...
  linkIconWrap:  { width:38, height:38, borderRadius:radius.sm, backgroundColor:colors.background, borderWidth:1, borderColor:colors.border, alignItems:"center", justifyContent:"center", flexShrink:0 },
  linkIcon:      { fontSize:16 },
  linkInfo:      { flex:1 },
  linkTitle:     { fontFamily:SERIF, fontSize:16, color:colors.text, marginBottom:2 },
  linkNote:      { fontSize:12, color:colors.subtext, marginBottom:1 },
  ...
  linksFooter: { fontSize:12, color:colors.subtext, textAlign:"center", lineHeight:18, marginTop:spacing(2), marginHorizontal:spacing(2.5) },
});
