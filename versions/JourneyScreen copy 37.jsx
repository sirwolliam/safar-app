...
const jn = StyleSheet.create({
  ...
  pageTitleRow:  { flexDirection:"row", alignItems:"flex-start", justifyContent:"space-between", marginBottom:2 },
  ...
  calFixed:             { backgroundColor:"#FDFAF4", paddingHorizontal:20, borderTopLeftRadius:24, borderTopRightRadius:24 },
  calDivider:           { height:1, backgroundColor:"#E8E0D0", marginTop:4, marginBottom:0 },
  calEntriesScroll:     { flex:1, paddingHorizontal:20 },
  ...
  pairRow:         { flexDirection:"row", gap:12, marginBottom:12, marginTop:8 },
