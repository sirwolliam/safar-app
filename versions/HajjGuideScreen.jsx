...
const s = StyleSheet.create({
  ...
  // Guide hero card
  guideCard:        { borderRadius:20, overflow:"hidden", height:200, marginBottom:16, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  ...
  accordionHeader: {
    ...
    backgroundColor:"#FDFAF4", borderRadius:14, borderWidth:1, borderColor:"#D4D0CA",
    paddingHorizontal:16, paddingVertical:14, marginBottom:4,
    shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.10, shadowRadius:6, elevation:3,
  },
  accordionLeft:  { flexDirection:"row", alignItems:"center", gap:12, flex:1 },
  accordionIcon:  { fontSize:18, color:"#2F5D50" },
  accordionTitle: { fontFamily:SERIF, fontSize:16, color:"#1A1712" },
  accordionSub:   { fontSize:12, color:"#5A5650", marginTop:1 },
  accordionRight: { flexDirection:"row", alignItems:"center", gap:10 },
  accordionChev:  { fontSize:11, color:"#5A5650" },

  // Mini progress bar inside checklist header
  miniProgTrack: { width:50, height:3, backgroundColor:"#D4D0CA", borderRadius:2, overflow:"hidden" },
  miniProgFill:  { height:"100%", backgroundColor:"#2F5D50", borderRadius:2 },

  // Accordion body (checklist rows)
  accordionBody: {
    backgroundColor:"#FDFAF4", borderRadius:14, borderWidth:1, borderColor:"#D4D0CA",
    overflow:"hidden", marginBottom:12,
    shadowColor:"#6A4A28", shadowOffset:{width:0,height:2}, shadowOpacity:0.08, shadowRadius:6, elevation:2,
  },
  ...
  duaRowBorder:  { borderBottomWidth:1, borderBottomColor:"#D4D0CA" },
  duaStagePill:  { backgroundColor:"#EBF2EE", borderRadius:6, paddingHorizontal:8, paddingVertical:3, flexShrink:0 },
  duaStageText:  { fontSize:10, color:"#2F5D50", fontWeight:"600" },
  duaTitle:      { flex:1, fontFamily:SERIF, fontSize:14, color:"#1A1712" },
  duaArrow:      { fontSize:18, color:"#D4D0CA" },

  // Sacred Places card
  sacredCard:        { borderRadius:16, overflow:"hidden", height:120, marginBottom:16, shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
  sacredCardBg:      { flex:1 },
