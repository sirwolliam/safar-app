...
function AboutSafarModal({ visible, onClose }) {
  return (
    <Modal visible={visible} transparent animationType="fade">
      ...
      >
        <View
          style={{ backgroundColor:"#FDFAF4", borderRadius:20, padding:28, width:"100%", shadowColor:"#1E3D30", shadowOffset:{width:0,height:8}, shadowOpacity:0.20, shadowRadius:24, elevation:12 }}
          onStartShouldSetResponder={() => true}
        >
          <Text style={{ fontFamily:SERIF, fontSize:22, fontWeight:"600", color:"#1E3D30", marginBottom:14 }}>What is Safar?</Text>
          <Text style={{ fontSize:15, color:"#3A3530", lineHeight:24, marginBottom:22 }}>{ABOUT_CONTENT}</Text>
          <TouchableOpacity
            style={{ backgroundColor:"#1E3D30", borderRadius:50, paddingHorizontal:32, paddingVertical:11, alignSelf:"flex-start" }}
            onPress={onClose}
          >
          ...
          <View style={s.headerIcons}>
            <TouchableOpacity style={s.headerIconBtn}
              ...
              <Svg width={18} height={18} viewBox="0 0 24 24" fill="none">
                <Circle cx="12" cy="12" r="10" stroke="#1E3D30" strokeWidth="1.8"/>
                <Path d="M9.5 9.5C9.5 8.12 10.62 7 12 7s2.5 1.12 2.5 2.5c0 1.5-2.5 2-2.5 3.5" stroke="#1E3D30" strokeWidth="1.8" strokeLinecap="round"/>
                <Circle cx="12" cy="17" r="0.8" fill="#1E3D30"/>
              </Svg>
            </TouchableOpacity>
            <TouchableOpacity style={s.headerIconBtn}
              ...
              {/* Gear — line style */}
              <Svg width={18} height={18} viewBox="0 0 24 24" fill="none">
                <Path d="M12 15a3 3 0 100-6 3 3 0 000 6z" stroke="#1E3D30" strokeWidth="1.8"/>
                <Path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke="#1E3D30" strokeWidth="1.8"/>
              </Svg>
            </TouchableOpacity>
          </View>
        </View>
        ...
        <View onLayout={e => { sectionY.current.settings = e.nativeEvent.layout.y; }}>
          ...
          <View style={s.menuCard}>
            <TouchableOpacity
              ...
              <View style={s.menuIconWrap}>
                <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
                  <Path d="M12 15a3 3 0 100-6 3 3 0 000 6z" stroke="#1E3D30" strokeWidth="1.6"/>
                  <Path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke="#1E3D30" strokeWidth="1.6"/>
                </Svg>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={s.menuIconWrap}>
                <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
                  <Circle cx="12" cy="12" r="10" stroke="#1E3D30" strokeWidth="1.6"/>
                  <Path d="M9.5 9.5C9.5 8.12 10.62 7 12 7s2.5 1.12 2.5 2.5c0 1.5-2.5 2-2.5 3.5" stroke="#1E3D30" strokeWidth="1.6" strokeLinecap="round"/>
                  <Circle cx="12" cy="17" r="0.8" fill="#1E3D30"/>
                </Svg>
              </View>
              <View style={s.menuInfo}>
            ...
            <TouchableOpacity
              ...
              <View style={s.menuIconWrap}>
                <Svg width={22} height={22} viewBox="0 0 24 24" fill="none">
                  <Path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z" stroke="#1E3D30" strokeWidth="1.6"/>
                  <Path d="M12 11v6M12 8v.5" stroke="#1E3D30" strokeWidth="1.8" strokeLinecap="round"/>
                </Svg>
              </View>
              <View style={s.menuInfo}>
...
const createStyles = (colors) => StyleSheet.create({
  ...
  headerIconTxt:  { fontSize:17, color:"#1E3D30" },
