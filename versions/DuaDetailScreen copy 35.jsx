...
// ── Header pattern — PNG image overlay ───────────────────────────────────────
// Black fades to transparent so gold lines read on the warm off-white background.
// opacity 0.18 lets the BG colour show through while pattern is clearly visible.
function HeaderPattern({ width, height }) {
  return (
    <Image
      source={require("../assets/Artboard_2_3x.png")}
      style={{
        position:"absolute",
        top:0,
        left:0,
