...
// ── Islamic geometric pattern — overlapping circles (zellige / muqarnas style) ─
// Matches the reference: dense grid of overlapping arcs creating petal/star forms.
// Each circle overlaps its neighbours at radius distance, forming the classic
// 4-petal flower motif found in Moroccan and Andalusian tilework.
function GeometricPattern({ width, height }) {
  const r  = 18;   // circle radius
  const dx = r;    // horizontal step — circles overlap at centre
  const dy = r;    // vertical step
