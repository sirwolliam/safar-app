...
const createStyles = (colors) => StyleSheet.create({
  ...
  pickerOptLeft: { gap: 4 },
  pickerOptTitle: { fontFamily: SERIF, fontSize: typography.title, color: "#100E0A" },
  pickerOptHint: { fontSize: 14, color: "#3A3530" },
  pickerBadge: {
    backgroundColor: "#E2EDE6", borderRadius: radius.pill,
  ...
  completeBtn: {
    ...
    justifyContent: "space-between", marginBottom: 16, ...shadows.button,
  },
  ...
  quickCard: {
    ...
    borderColor: "#C8BFB2", padding: spacing(1.75), gap: 4, shadowColor:"#4A2E10", shadowOffset:{width:0,height:3}, shadowOpacity:0.20, shadowRadius:10, elevation:5,
  },
  quickIconWrap: {
    width: 36, height: 36, borderRadius: radius.sm, backgroundColor: "#E2EDE6",
