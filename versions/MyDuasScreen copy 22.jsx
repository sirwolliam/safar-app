...
const TAB_ITEMS = [
  { key:"myLists", label:"My Dua Lists",  sub:"Your personal duas, saved and ready to recite", img:require("../assets/tab_dua_library.jpg")  },
  { key:"library", label:"Dua Library",   sub:"Explore duas for every moment of your journey",  img:require("../assets/tab_my_lists.jpg")     },
  { key:"shared",  label:"Shared Duas",   sub:"Duas from your groups and fellow pilgrims",       img:require("../assets/tab_shared_duas.jpg")  },
];
