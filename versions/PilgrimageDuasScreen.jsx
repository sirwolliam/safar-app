...
const UMRAH_STAGE_ORDER = [
  "Ihram", "Entry", "Tawaf", "Maqam", "Saʿy",
  "Zamzam", "Completion", "Farewell",
];
const HAJJ_STAGE_ORDER = [
  "Ihram", "Entry", "Tawaf", "Maqam", "Saʿy",
  "Zamzam", "Arafah", "Muzdalifah", "Jamarat",
  ...
  return (
    <View style={ss.block}>
      ...
      >
        ...
        <Text style={ss.stageName}>{stage === "Saʿy" ? "Saʿy" : stage}</Text>
      </ImageBackground>
      ...
      <Text style={ss.sectionLabel}>{"Du\u02bfās for " + (stage === "Saʿy" ? "Sa\u02bfy" : stage)}</Text>
