...
const sc = StyleSheet.create({
  ...
  roleText:     { fontSize:9, color:colors.primary, fontWeight:"600" },
  phone:        { fontSize:typography.small, color:colors.primary, marginBottom:2 },
  note:         { fontSize:typography.tiny, color:colors.subtext, fontWeight:"300", lineHeight:16 },
...
const s = StyleSheet.create({
  ...
  headerSub:         { fontSize:typography.tiny, color:colors.subtext, fontWeight:"300", marginTop:1 },
  ...
  hint:              { fontSize:typography.tiny, color:colors.subtext, fontWeight:"300" },
  scroll:            { paddingHorizontal:spacing(2.5), paddingTop:spacing(0.5) },
  reorderNote:       { fontSize:typography.tiny, color:colors.subtext, fontWeight:"300", marginBottom:spacing(1.5), lineHeight:17 },
