...
const lc = StyleSheet.create({
  ...
  chip:   { paddingHorizontal:14, paddingVertical:7, borderRadius:999, borderWidth:1, borderColor:"#D4D0CA", backgroundColor:"#FDFAF4" },
  chipOn: { backgroundColor:"#2F5D50", borderColor:"#2F5D50" },
  label:  { fontSize:13, color:"#3D3935" },
...
const sc = StyleSheet.create({
  ...
  arabic:     { fontSize: 18, color: "#3D3935", marginBottom: 2 },
  sub:        { fontSize: 14, color: "#3D3935", marginBottom: 10 },
  detail:     { fontSize: 12, color: "#3D3935", lineHeight: 18, marginBottom: 10, fontStyle: "italic" },
  ...
  countLabel: { fontSize: 14, color: "#3D3935" },
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <LocationChips sites={sites} selectedId={selected?.id} onSelect={setSelected} />
...
const createStyles = (C) => StyleSheet.create({
  ...
  madinahNote:     { marginHorizontal:20, marginTop:12, marginBottom:12, backgroundColor:"#F5EDD8", borderRadius:10, borderWidth:1, borderColor:"#E8D9B8", padding:14 },
  ...
  listTitle:   { fontSize:12, fontWeight:"600", color: C.subtext, letterSpacing:1.5, textTransform:"uppercase", marginBottom:12 },
  ...
  dot:         { width:8, height:8, borderRadius:4, backgroundColor: C.border, flexShrink:0 },
  ...
  linksCard:  { marginHorizontal:20, marginTop:16, backgroundColor: C.card, borderRadius:10, borderWidth:1, borderColor: C.border, overflow:"hidden", shadowColor:"#6A4A28", shadowOffset:{width:0,height:3}, shadowOpacity:0.14, shadowRadius:8, elevation:4 },
