        ...
        {!importDismissed && (
          <TouchableOpacity style={jn.importCard}
            ...
            <View style={jn.importCardLeft}>
              <Text style={jn.importCardEyebrow}>NEW</Text>
              <Text style={jn.importCardTitle}>Set Up My Journey</Text>
              <Text style={jn.importCardSub}>{"Paste your booking confirmation and Safar fills in your dates, hotel and contacts automatically."}</Text>
            </View>
            <View style={{ gap:10, alignItems:"center" }}>
              <View style={jn.arrowCircle}>
                <Text style={{ fontSize:18, color:"rgba(255,255,255,0.9)" }}>{"›"}</Text>
              </View>
              <TouchableOpacity onPress={dismissImport} hitSlop={{top:12,bottom:12,left:12,right:12}}>
                <Text style={{ fontSize:13, color:"rgba(255,255,255,0.55)", fontWeight:"600" }}>{"✕"}</Text>
              </TouchableOpacity>
            </View>
          </TouchableOpacity>
        )}
...
const jn = StyleSheet.create({
  ...
  importCardSub:     { fontSize:13, color:"rgba(255,255,255,0.78)", fontWeight:"500", lineHeight:18 },
  ...
  datesCardEyebrow: { fontSize:9, fontWeight:"700", letterSpacing:2, color:"#5C534A", marginBottom:4, textTransform:"uppercase" },
